  ...
  _createClass(AdjustHelper, null, [
      ...
      value: function Breaker(obj, id) {
        if (
          ...
          (obj.RowId == id ||
            ...
            obj.IndexFlag == id ||
            (obj.ControlInfo &&
              (obj.ControlInfo.RowId == id ||
                obj.ControlInfo.CtrlId == id ||
                obj.ControlInfo.ElementId == id ||
                obj.ControlInfo.IndexFlag == id)))
        )
          debugger;
      },
    },
    ...
    },
    {
      ...
      value: function GetPicSize(imgEle) {
        if (imgEle.length > 0) {
          return {
            width: imgEle[0].naturalWidth,
            height: imgEle[0].naturalHeight,
          };
        } else {
    ...
    },
    {
      ...
      value: function ResetTempId(ele) {
        ...
        ele.find("[id]").each(function (a, b) {
          $(b).attr(
            "id",
            $(b).attr("id").replace(AdjustConfig.TempIdSuffix, "")
          );
        });
      },
    },
...
AdjustConfig.UnSupportCtrlList = [
  "codeCnzz",
  "qqservice",
  "form",
  "submit",
  ...
  _createClass(baseAdjuster, [
    {
      ...
      value: function IsSetMinZoom() {
        return (
          this.ControlInfo.ControlView &&
          this.ControlInfo.ControlView.attr("MinZoom") !== undefined
        );
      },
    },
    {
    ...
    [
      ...
      },
      {
        ...
        value: function AdjustListItem(func) {
          ...
          var oriBorderWidth =
            self.OriBorderWidth === undefined ? 1 : self.OriBorderWidth;
          ...
          if (newItemWidth > ctrlWidth) {
            ...
            ctrlWidth -=
              marginLeft * (oneLineCount - 1) +
              oneLineCount * oriBorderWidth * 2; //1px 左右border
            newItemWidth = ctrlWidth / oneLineCount;
          }

          var newItemHeight =
            (newItemWidth / self.OriPicWidth) * self.OriPicHeight;
          func(
            AdjustHelper.ToFixed(newItemWidth),
            AdjustHelper.ToFixed(newItemHeight),
            AdjustHelper.ToFixed(marginLeft),
            oneLineCount
          );
        },
      },
      {
        ...
        value: function ShouldHideOriNav(ctrl) {
          if (
            ctrl.ControlView &&
            ctrl.ControlView.hasClass("notTransfer2HamburgNav")
          ) {
            return false;
          }
          return (
            (CtrlAdjuster.GetCurrentBrowserWidth() <
              AdjustConfig.SmallScreenWidth ||
              CtrlAdjuster.IsMobile) &&
            !ctrl.IsChildNodeOfSpecCtrlName("area", "Style3")
          );
        },
      },
      {
        ...
        value: function AppendTips(tips) {
          if (!this.ControlInfo.IsVirtualCtrl) {
            if (AdjustConfig.NeedShowTips) {
              ...
              this.ControlInfo.ControlView.attr(
                "DebuggerMsg",
                oriTitle.join("-->")
              );
            }
      ...
      },
      {
        ...
        value: function SetWidthAndHeight_OriSize() {
          ...
          this.ControlInfo.AdjustControlInfo.Width =
            this.ControlInfo.DisplayWidth;
        },
      },
      {
      ...
      },
      {
        ...
        value: function SetWidthAndHeight_ZoomHeight(newWidth) {
          ...
          this.ControlInfo.AdjustControlInfo.Width = newWidth;
          this.ControlInfo.AdjustControlInfo.Height =
            this.ControlInfo.Height * zoomVal;
        },
      },
      {
        ...
        value: function SetWidthAndHeight_IncreaseHeight(newWidth) {
          ...
          if (zoomVal < 1) {
            this.ControlInfo.AdjustControlInfo.Height =
              this.ControlInfo.DisplayHeight / zoomVal;
          }
        },
      },
      {
      ...
      },
      {
        ...
        value: function SetSingleCellCtrlLayout_HundredPercent() {
          this.AppendTips(
            "\u63A7\u4EF6\u5BBD\u5EA6\u4E0E\u7236\u5BB9\u5668\u5BBD\u5EA6\u6BD4\u503C\u9AD8\u4E8E" +
              AdjustConfig.HighWidthProportionPercent +
              ":\u89E6\u53D1\u5BBD\u5EA6\u94FA\u6EE1\u7236\u7EA7\u6548\u679C"
          );
          var cell = this.ControlInfo;
          cell.AdjustControlInfo.Left = cell.ParentXPadding;
          cell.CtrlAdjuster.SetWidthAndHeight(
            cell.AdjustControlInfo.ParentWidthSubPadding
          );
        },
      },
      {
        ...
        value: function SetSingleCellCtrlLayout_ZoomLayout() {
          ...
          cell.AdjustControlInfo.Left =
            cell.PreLoadAdjustControlInfo.ZoomLeft -
            (cell.DisplayWidth - cell.PreLoadAdjustControlInfo.ZoomWidth);
      ...
      },
      {
        ...
        value: function SetSingleCellCtrlLayout_Center() {
          ...
          var cell = this.ControlInfo;
          var adjWidth =
            cell.DisplayWidth > cell.AdjustControlInfo.ParentWidthSubPadding
              ? cell.AdjustControlInfo.ParentWidthSubPadding
              : cell.DisplayWidth;
          var left =
            (cell.AdjustControlInfo.ParentWidthSubPadding - adjWidth) / 2 +
            cell.ParentXPadding;
      ...
      },
      {
        ...
        value: function ChangedRowAct_WidthAsHeader(
          cell,
          headerCtrlLayout,
          header
        ) {
      ...
      },
      {
        ...
        value: function ChangedRowAct_SetCenter(
          cell,
          headerCtrlLayout,
          header
        ) {
      ...
      },
      {
        ...
        value: function ChangedRowAct_AlignLeft(
          cell,
          headerCtrlLayout,
          header
        ) {
          ...
          cell.AdjustControlInfo.Left = headerCtrlLayout.Left;
          var shouldSameWidthAsHeader =
            cell.Width / header.Width > AdjustConfig.HighWidthProportionPercent;
        ...
        value: function HundredPercentHandler() {
          if (this.IsHightWidthProportion()) {
            ...
            if (
              ...
              cell.IsContainer ||
              //是居中的
              Math.abs((cell.ParentWidth - cell.Width) / 2 - cell.Left) <
                AdjustConfig.DeviationOffset
            ) {
              this.SetSingleCellCtrlLayout_Center();
            } else {
        ...
        value: function ResetTag2OriCss() {
          ...
          if (!this.ControlInfo.IsVirtualCtrl) {
            if (this.TagMarkList === null) {
              ...
              this.ControlInfo.ControlView.find("[ctype]").find(
                "[" + tagMarkerFlag + "]"
              );
              this.ControlInfo.ControlView.find("[" + tagMarkerFlag + "]").each(
                function (a, b) {
              ...
              this.ControlInfo.ControlView.find("[" + tagMarkerFlag + "]").each(
                function (a, b) {
                  ...
                  if (
                    childTagMarkerList.indexOf(tmId) === -1 &&
                    !$(b).attr("[ctype]")
                  ) {
      ...
      },
      {
        ...
        value: function SetCtrlCss(layout) {
          ...
          this.SetEleWidthAndHeightByAdjustControlInfo(
            this.ControlInfo.ControlView,
            layout
          );
          ...
          for (var x = 0; x < eleList.length; x++) {
            ...
            if (css.left || css.top) {
              ...
              if (css.left && typeof css.left === "string") {
                css.left =
                  css.left.replace("px", "") * 1 + virtualAreaLeftOffset;
              }
            }
      ...
      },
      {
        ...
        value: function AdjustLayout(ctrlAdjuster) {
          ...
          var headerCtrl = ctrlAdjuster.GetHeaderByIndex(
            ctrlIndexOfRow,
            cells,
            newColumnCount
          );
          ...
          var isOverflowOfLine =
            overflowStartIndex !== null
              ? ctrlIndexOfRow >= overflowStartIndex
              : false;
          ...
          function AfterLastCtrlAdjusted(firstLine) {
            ...
            var firstPreLoadRowAdjustControlInfo =
              firstCtrl.RowInfo.PreLoadRowAdjustControlInfo.find(function (i) {
                return i.CtrlId === firstCtrl.CtrlId;
              });
            var lastPreLoadRowAdjustControlInfo =
              firstCtrl.RowInfo.PreLoadRowAdjustControlInfo.find(function (i) {
                return i.CtrlId === lastCtrl.CtrlId;
              });
            var firstLineWidth = firstLine
              .map(function (i) {
                return i.Width;
              })
              .reduce(function (a, b) {
            ...
            var widthOffset =
              firstCtrl.ParentWidth -
              firstPreLoadRowAdjustControlInfo.ZoomLeft -
              lastPreLoadRowAdjustControlInfo.ZoomRight;
            if (widthOffset > 0) {
              var totalRedundantWidthPerCtrl = 0;
              for (var i = 0; i < firstLine.length; i++) {
                var ctrl = firstLine[i];
                var redundantWidthPerCtrl =
                  (ctrl.Width / firstLineWidth) * widthOffset;
                ctrl.Left += totalRedundantWidthPerCtrl;
                totalRedundantWidthPerCtrl += redundantWidthPerCtrl;

                ctrl.ControlInfo.CtrlAdjuster.SetWidthAndHeight(
                  ctrl.Width + redundantWidthPerCtrl
                );
              }
            }
          }
          ...
          if (isOverflowOfLine) {
            ...
            if (cell.IsFirstCell) {
              ...
              while (
                prevLineCell != null &&
                prevLineCell.AdjustControlInfo.LineNum > 0 &&
                --maxLoop > 0
              ) {
              ...
              //取较小的差值
              var smallOneOffset =
                heightOffset > topOffset ? topOffset : heightOffset;

              cell.AdjustControlInfo.AddParentHeight(
                smallOneOffset + (lineNum + 1) * cell.ParentYPadding
              );
          ...
          //没有溢出
            ...
            if (cells.length === 1) {
              ...
              cell.AdjustControlInfo.Left =
                cell.PreLoadAdjustControlInfo.ZoomLeft;
              cell.CtrlAdjuster.SetWidthAndHeight(
                cell.PreLoadAdjustControlInfo.ZoomWidth
              );
            }
          }
      ...
      },
      {
        ...
        value: function GenerateNav(navInfo) {
          ...
          self.ControlInfo.ControlView.prepend(
          ...
          nav.slicknav({
            ...
            afterOpen: function afterOpen(trigger) {
              ...
              if (current.hasClass("slicknav_item")) {
                current
                  .parent(".slicknav_parent")
                  .siblings(".slicknav_open")
                  .children("a.slicknav_item")
                  .click();
              }
            },
          });
          nav.remove();
          var autoCreatedNav =
            this.ControlInfo.ControlView.find(".slicknav_menu");
          function FormatLayout() {
            ...
            autoCreatedNav
              .find(".slicknav_item")
              .css("color", navInfo.ForegroundColor);
      ...
      },
      {
        ...
        value: function GenerateNavHtml(tree) {
          ...
          if (
            this.ControlInfo.CtrlName === "category" &&
            this.ControlInfo.StyleName === "Style4"
          ) {
          ...
          if (tree.length > 0) {
            ...
            tree.forEach(function (item) {
              ...
              html +=
                '<li><span onclick="' +
                (isATagRedirect
                  ? "$('[nav-click-id=" + clickId + "]')[0].click();"
                  : "$('[nav-click-id=" +
                    clickId +
                    "]').find('[data-url]').each(function(a,b){if(a==0){ b.click();}})") +
                '"> ' +
                item.text +
                "</span>" +
                self.GenerateNavHtml(item.children) +
                "</li>"; //
            });
            html += "</ul>";
            return html;
          ...
          if (children.length === 0) {
            ...
            for (var x = 0; x < children.length; x++) {
              children = children.concat(
                this.GetAllChildrenByParentId(children[x].CtrlId)
              );
            }
            return children;
          }
      ...
      },
      {
        ...
        get: function get() {
          return this.CurrentZoomVal > this.MinZoom
            ? this.CurrentZoomVal
            : this.MinZoom;
        },
      },
        ...
        value: function InitAdjuster(controlInfo) {
          return eval(
            "typeof " +
              ...
              'Adjuster==="function"?new ' +
              controlInfo.CtrlName +
              "Adjuster(controlInfo): new baseAdjuster(controlInfo)"
          );
        },
      },
      {
        ...
        value: function GetNavColor(foregroundEleList, backgroundEleList) {
          ...
          foregroundEleList.each(function (a, b) {
            //以防只有一个导航时无法取到颜色
            if (
              $(b).closest("ul").find("li").length <= 1 ||
              $(b).closest(".current").length === 0
            ) {
              foregroundColorList[$(b).css("color")] =
                foregroundColorList[$(b).css("color")] || 1;
              ++foregroundColorList[$(b).css("color")];
            }
          });
          ...
          Object.keys(foregroundColorList).forEach(function (key) {
            if (
              foregroundColorList[key] > foregroundColorInfo.Counter &&
              key !== backgroundColorInfo.Color
            ) {
...
var fixMinZoomAs1Adjuster = (function (_baseAdjuster) {
  ...
  _createClass(fixMinZoomAs1Adjuster, [
    {
      key: "MinZoom",
      get: function get() {
        return this.IsSetMinZoom()
          ? _get(
              fixMinZoomAs1Adjuster.prototype.__proto__ ||
                Object.getPrototypeOf(fixMinZoomAs1Adjuster.prototype),
              "MinZoom",
              this
            )
          : 1;
  ...
  function fixMinZoomAs1Adjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        fixMinZoomAs1Adjuster.__proto__ ||
        Object.getPrototypeOf(fixMinZoomAs1Adjuster)
      ).call(this, controlInfo)
    );
  }
...
var imageAdjuster = (function (_baseAdjuster2) {
  ...
  function imageAdjuster(controlInfo) {
    ...
    var _this2 = _possibleConstructorReturn(
      this,
      (imageAdjuster.__proto__ || Object.getPrototypeOf(imageAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(imageAdjuster, [
    ...
    },
    {
      ...
      value: function SetWidthAndHeight(newWidth) {
        if (this.IsReachMaxZoom(newWidth)) {
          ...
          this.ControlInfo.AdjustControlInfo.Height =
            this.ControlInfo.Height * this.MaxZoom;
        ...
        return this.IsReachMaxZoom(this.ControlInfo.AdjustControlInfo.Width)
          ? {
              Left: (this.ControlInfo.AdjustControlInfo.Left +=
                (this.ControlInfo.AdjustControlInfo.Width -
                  this.ControlInfo.Width * this.MaxZoom) /
                2),
    ...
    },
    {
      ...
      value: function Reset2OriCss() {
        if (this.FillType !== null) {
          InitImageSmv(
            this.ControlInfo.CtrlId,
            this.ControlInfo.Width,
            this.ControlInfo.Height,
            this.FillType,
            this.ControlInfo.ControlView.find("img")[0]
          );
        }
      },
    },
    {
      ...
      value: function SetCtrlCss() {
        ...
        _get(
          imageAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(imageAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this, layout);
        this.SetEleWidthAndHeightByAdjustControlInfo(
          this.ControlInfo.ControlView.find("img")
        );
...
var logoimageAdjuster = (function (_imageAdjuster) {
  ...
  function logoimageAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        logoimageAdjuster.__proto__ || Object.getPrototypeOf(logoimageAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var lineAdjuster = (function (_baseAdjuster3) {
  ...
  _createClass(lineAdjuster, [
    {
      ...
      get: function get() {
        return this.IsSetMinZoom()
          ? _get(
              lineAdjuster.prototype.__proto__ ||
                Object.getPrototypeOf(lineAdjuster.prototype),
              "MinZoom",
              this
            )
          : this.IsVerticalLine_Local
          ? 0.1
          : _get(
              lineAdjuster.prototype.__proto__ ||
                Object.getPrototypeOf(lineAdjuster.prototype),
  ...
  function lineAdjuster(controlInfo) {
    ...
    var _this4 = _possibleConstructorReturn(
      this,
      (lineAdjuster.__proto__ || Object.getPrototypeOf(lineAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(lineAdjuster, [
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        ...
        if (!this.IsVerticalLine_Local) {
          this.SetEleWidthAndHeightByAdjustControlInfo(
            this.ControlInfo.ControlView.find("a")
          );
          this.SetEleCss(this.ControlInfo.ControlView.find(".w-line"), {
    ...
    },
    {
      ...
      get: function get() {
        return (
          this.IsLine &&
          this.ControlInfo.ControlView.attr("re-direction") === "y"
        );
      },
    },
  ]);
...
var buttonAdjuster = (function (_baseAdjuster4) {
  ...
  function buttonAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (buttonAdjuster.__proto__ || Object.getPrototypeOf(buttonAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(buttonAdjuster, [
    {
      ...
      value: function SetCtrlCss() {
        _get(
          buttonAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(buttonAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
...
var multicolumnVirtualItemAdjuster = (function (_baseAdjuster5) {
  ...
  _createClass(multicolumnVirtualItemAdjuster, [
    {
      ...
      // multicolumn 响应式优化
      get: function get() {
        return CtrlAdjuster.GetCurrentBrowserWidth() <= 500
          ? 1
          : _get(
              multicolumnVirtualItemAdjuster.prototype.__proto__ ||
                Object.getPrototypeOf(multicolumnVirtualItemAdjuster.prototype),
              "MinZoom",
              this
            );
      },
  ...
  function multicolumnVirtualItemAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        multicolumnVirtualItemAdjuster.__proto__ ||
        Object.getPrototypeOf(multicolumnVirtualItemAdjuster)
      ).call(this, controlInfo)
    );
  }
  ...
  _createClass(multicolumnVirtualItemAdjuster, [
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        ...
        var spacing =
          this.ControlInfo.Parent.ControlView.find(".w-columns").attr(
            "data-spacing"
          );
        ...
        switch (this.ControlInfo.StyleName) {
          case "Style1": {
            if (this.IsFullScreen) {
              ...
              this.SetEleCss(
                this.ControlInfo.ControlView.find(".w-columns-content-inner"),
                { width: this.ControlInfo.AdjustControlInfo.Width + "px" }
              );
              this.SetEleCss(
                this.ControlInfo.ControlView.find(".w-columns-interval"),
          ...
          case "Style2": {
            if (this.IsFullScreen) {
              ...
              //    this.ControlInfo.ControlView.find(".w-columns-interval").css({ padding: `0` });
              this.SetEleCss(
                this.ControlInfo.ControlView.find(".lz-parallax-bg-inner"),
                { width: this.ControlInfo.AdjustControlInfo.Width + "px" }
              );
              this.SetEleCss(
                this.ControlInfo.ControlView.find(".lz-parallax-bg"),
                {
                  clip:
                    "rect(0px, " +
                    this.ControlInfo.AdjustControlInfo.Width +
...
var multicolumnAdjuster = (function (_baseAdjuster6) {
  ...
  function multicolumnAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        multicolumnAdjuster.__proto__ ||
        Object.getPrototypeOf(multicolumnAdjuster)
      ).call(this, controlInfo)
    );
  }
  ...
  _createClass(multicolumnAdjuster, [
    {
      ...
      value: function Reset2OriCss() {
        // multicolumn 响应式优化
        _get(
          multicolumnAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(multicolumnAdjuster.prototype),
          "Reset2OriCss",
          this
        ).call(this);
        if (this.IsFullScreen) {
          ...
          items.each(function () {
            ...
            $(this).css({
              width: itemPx + spacing + "px",
              height: self.ControlInfo.Height + "px",
            });
          ...
          try {
            if (this.ControlInfo.StyleName == "Style2") {
              $("#mc_" + this.ControlInfo.CtrlId).lzparallax({
                effect: $("#mc_" + this.ControlInfo.CtrlId).data(
                  "lzparallaxParam"
                ).effect,
                autoPosition: false,
                clone: true,
              });
              this.ControlInfo.ControlView.find(
                ".w-columns-content-inner"
              ).each(function (a, b) {
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        ...
        switch (this.ControlInfo.StyleName) {
          ...
          default: {
            this.SetEleCss(
              this.ControlInfo.ControlView.find(".w-columns").children(),
              { "margin-left": "0px" }
            );
            this.SetEleCss(this.ControlInfo.ControlView.find(".w-columns"), {
              width: this.ControlInfo.AdjustControlInfo.Width + "px",
              left: "0px",
            });
            ...
            _get(
              ...
              this,
              this.ControlInfo.ControlView.find(
                "#mc_" + this.ControlInfo.CtrlId
              )
            );
            this.ControlInfo.ControlView.find("#mc_" + this.ControlInfo.CtrlId)
              .find(".w-columns-content-inner")
              .each(function (a, b) {
                _get(
                  multicolumnAdjuster.prototype.__proto__ ||
                    Object.getPrototypeOf(multicolumnAdjuster.prototype),
...
var areaAdjuster = (function (_baseAdjuster7) {
  ...
  function areaAdjuster(controlInfo) {
    ...
    var _this9 = _possibleConstructorReturn(
      this,
      (areaAdjuster.__proto__ || Object.getPrototypeOf(areaAdjuster)).call(
        this,
        controlInfo
      )
    );
    ...
    _this9.LeftBorder = AdjustHelper.GetCssPixelSize(
      controlInfo.ControlView.find(".w-container"),
      "border-left-width"
    );
    _this9.RightBorder = AdjustHelper.GetCssPixelSize(
      controlInfo.ControlView.find(".w-container"),
      "border-right-width"
    );
    return _this9;
  ...
  _createClass(areaAdjuster, [
    {
      ...
      value: function SetWidthAndHeight(newWidth) {
        _get(
          areaAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(areaAdjuster.prototype),
          "SetWidthAndHeight",
          this
        ).call(this, newWidth);
        this.ControlInfo.AdjustControlInfo.Width4Children =
          newWidth - this.LeftBorder - this.RightBorder;
      },
    },
    {
      key: "SetCtrlCss",
      value: function SetCtrlCss() {
        ...
        this.SetEleCss(
          this.ControlInfo.ControlView.find(".smAreaC.expandFlag"),
          { height: this.ControlInfo.AdjustControlInfo.Height + "px" }
        );
      },
    },
...
var virtualAreaAdjuster = (function (_baseAdjuster8) {
  ...
  function virtualAreaAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        virtualAreaAdjuster.__proto__ ||
        Object.getPrototypeOf(virtualAreaAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var textAdjuster = (function (_baseAdjuster9) {
  ...
  function textAdjuster(controlInfo) {
    ...
    var _this11 = _possibleConstructorReturn(
      this,
      (textAdjuster.__proto__ || Object.getPrototypeOf(textAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(textAdjuster, [
    ...
    },
    {
      ...
      value: function GetDisplayHeightNotLimit(newWidth) {
        ...
        return this.PassHiddenCtrls(function (self) {
          ...
          var height = 0;
          var children =
            self.ControlInfo.ControlView.find(".editableContent").children();
    ...
    },
    {
      ...
      value: function SetWidthAndHeight(newWidth) {
        ...
        if (this.HasBigFont) {
          ...
          this.SetLayout();
          this.ControlInfo.AdjustControlInfo.Height =
            this.GetDisplayHeightNotLimit(newWidth);
        } else {
          var adjustHeight = this.GetDisplayHeightNotLimit(newWidth);
          this.ControlInfo.AdjustControlInfo.Height =
            adjustHeight > this.ControlInfo.Height
              ? adjustHeight
              : this.ControlInfo.Height;
        }
      },
    },
    {
      ...
      value: function SetLayout() {
        ...
        _get(
          textAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(textAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
        var self = this;
...
var altasAdjuster = (function (_baseAdjuster10) {
  ...
  function altasAdjuster(controlInfo) {
    ...
    var _this13 = _possibleConstructorReturn(
      this,
      (altasAdjuster.__proto__ || Object.getPrototypeOf(altasAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(altasAdjuster, [
      ...
      value: function GetOriPicWidth() {
        if (this.OriPicWidth === null) {
          switch (this.ControlInfo.StyleName) {
            ...
            case "Style4": {
              var item =
                this.ControlInfo.ControlView.find(".w-imglist-item").eq(0);
              this.OriPicWidth = item.width();
              this.OriPicHeight = item.height();
              this.OriMarginLeft = AdjustHelper.GetCssPixelSize(
                item,
                "margin-left"
              );
            ...
            case "Style2": {
              var item =
                this.ControlInfo.ControlView.find(".w-atlas-ul>li").eq(0);
              this.OriPicWidth = item.width();
              this.OriPicHeight = item.height();
              this.OriMarginLeft = AdjustHelper.GetCssPixelSize(
                item.find("a"),
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        ...
        this.ResetTag2OriCss();
        _get(
          altasAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(altasAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
        ...
        switch (this.ControlInfo.StyleName) {
          case "Style1": {
            self.AdjustListItem(function (
              newItemWidth,
              newItemHeight,
              marginLeft,
              oneLineCount
            ) {
              self.ControlInfo.ControlView.find(".w-imglist-item").each(
                function (a, b) {
                  var liItem = $(b);
                  _this14.SetEleCss(liItem, {
                    width: newItemWidth + "px",
                    height: newItemHeight + "px",
                    "margin-left": marginLeft + "px",
                  });
                  _this14.SetEleCss(liItem.find("img").eq(0), {
                    width: newItemWidth + "px",
                    height: newItemHeight + "px",
                    "margin-top": 0,
                    "margin-left": 0,
                  });
                  _this14.SetEleCss(liItem.find(".w-imglist-in").eq(0), {
                    width: newItemWidth + "px",
                    height: newItemHeight + "px",
                  });
                  _this14.SetEleCss(liItem.find(".w-imglist-img").eq(0), {
                    width: newItemWidth + "px",
                    height: newItemHeight + "px",
                  });
                }
              ...
              self.SetEleCss(
                self.ControlInfo.ControlView.find(".w-imglist-ul"),
                { "margin-left": "-" + marginLeft + "px" }
              );
            });
            break;
          ...
          case "Style2": {
            self.AdjustListItem(function (
              ...
              self.ControlInfo.ControlView.find(".w-atlas-ul>li").each(
                function (a, b) {
                  var liItem = $(b);
                  var marginTop =
                    newItemHeight - liItem.find("h3").eq(0).height();
                  ...
                  _this14.SetEleCss(liItem.find("a").eq(0), {
                    width: newItemWidth + "px",
                    height: newItemHeight + "px",
                    "margin-left": 0,
                  });
                  _this14.SetEleCss(liItem.find("h3").eq(0), {
                    width: newItemWidth + "px",
                    padding: 0,
                  ...
                  $(
                    "#smv_" + _this14.ControlInfo.CtrlId + " .w-atlas-ul li img"
              ...
              self.SetEleCss(self.ControlInfo.ControlView.find(".w-atlas-ul"), {
                "margin-left": "-" + marginLeft + "px",
              });
            });
            break;
            ...
            self.AdjustListItem(function (
              ...
              self.ControlInfo.ControlView.find(".w-imglist-item").each(
                function (a, b) {
                  ...
                  _this14.SetEleCss(
                    liItem.find(".w-imglist-img,.w-imglist-in"),
                    {
                      width: newItemWidth + "px",
                      height: newItemHeight + "px",
                      "margin-top": 0,
                  ...
                  _this14.SetEleCss(liItem.find(".w-imglist-img>img"), {
                    width: newItemWidth + "px",
                    height: newItemHeight + "px",
                  });
                }
...
var browserdeviceAdjuster = (function (_fixMinZoomAs1Adjuste) {
  ...
  function browserdeviceAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        browserdeviceAdjuster.__proto__ ||
        Object.getPrototypeOf(browserdeviceAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var cartAdjuster = (function (_fixMinZoomAs1Adjuste2) {
  ...
  function cartAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (cartAdjuster.__proto__ || Object.getPrototypeOf(cartAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(cartAdjuster, [
    {
      ...
      value: function SetCtrlCss() {
        _get(
          cartAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(cartAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
        switch (this.ControlInfo.StyleName) {
          case "Style1": {
            ...
            var left =
              this.ControlInfo.ControlView[0].getBoundingClientRect().left -
              AdjustConfig.MinCtrlXPadding;
            if (left < promptBoxDefaultWidth) {
              this.SetEleCss(
                this.ControlInfo.ControlView.find(".w-shoppingcart-prompt"),
                { left: 0, right: "" }
              );
            } else {
              this.SetEleCss(
...
var cartQuantityAdjuster = (function (_fixMinZoomAs1Adjuste3) {
  ...
  function cartQuantityAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        cartQuantityAdjuster.__proto__ ||
        Object.getPrototypeOf(cartQuantityAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var cartSubmitButtonAdjuster = (function (_fixMinZoomAs1Adjuste4) {
  ...
  function cartSubmitButtonAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        cartSubmitButtonAdjuster.__proto__ ||
        Object.getPrototypeOf(cartSubmitButtonAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var categoryAdjuster = (function (_baseAdjuster11) {
  ...
  function categoryAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        categoryAdjuster.__proto__ || Object.getPrototypeOf(categoryAdjuster)
      ).call(this, controlInfo)
    );
  }
  ...
  _createClass(categoryAdjuster, [
    {
      ...
      value: function HundredPercentHandler() {
        if (
          !this.ControlInfo.IsTemplateCtrl &&
          this.ShouldHideOriNav(this.ControlInfo)
        ) {
          this.SetSingleCellCtrlLayout_HundredPercent();
        } else {
          _get(
            categoryAdjuster.prototype.__proto__ ||
              Object.getPrototypeOf(categoryAdjuster.prototype),
    ...
    },
    {
      ...
      value: function GetNavInfo() {
        ...
        switch (this.ControlInfo.StyleName) {
          ...
          case "Style2":
          case "Style4": {
            var firstNode = self.ControlInfo.ControlView.find(
            ...
            var _baseAdjuster$GetNavC = baseAdjuster.GetNavColor(
                self.ControlInfo.ControlView.find(
                  ".w-category-list-title"
                ).find("a"),
                self.ControlInfo.ControlView.find(".w-category-list-title")
              ),
          ...
          case "Style3": {
            var firstNode =
              self.ControlInfo.ControlView.find(".w-classify-once");
            var firstTree = [];
            firstNode.each(function (a, b) {
              var item = $(b);
              var node0 = {
                text: item.find(".w-classify-once-content").html(),
                children: [],
                ele: item.find(".w-classify-once-item.click").eq(0),
              };
              var secondNode = item.find(".w-classify-second");
              secondNode.each(function (a1, b1) {
                var item1 = $(b1);
                var node1 = {
                  text: item1.find(".w-classify-second-link").html(),
                  children: [],
                  ele: item1.find(".w-classify-second-item.click").eq(0),
                };
                node0.children.push(node1);
                ...
                thridNode.each(function (a2, b2) {
                  var item2 = $(b2);
                  var node2 = {
                    text: item2.find(".w-classify-third-link").html(),
                    children: [],
                    ele: item2.find(".w-classify-third-link.click").eq(0),
                  };
                  node1.children.push(node2);
                });
              });
            ...
            var _baseAdjuster$GetNavC2 = baseAdjuster.GetNavColor(
                self.ControlInfo.ControlView.find(".w-classify-title-txt"),
                self.ControlInfo.ControlView.find(".w-classify-title")
              ),
          ...
          case "Style5": {
            ...
            firstNode.each(function (a, b) {
              var item = $(b);
              var node0 = {
                text: item.find(".w-first-link").html(),
                children: [],
                ele: item.find(".w-first-link"),
              };
              var secondNode = item.find(".w-second-item");
              secondNode.each(function (a1, b1) {
                var item1 = $(b1);
                var node1 = {
                  text: item1.find(".w-second-link").html(),
                  children: [],
                  ele: item1.find(".w-second-link"),
                };
                node0.children.push(node1);
                ...
                thridNode.each(function (a2, b2) {
                  var item2 = $(b2);
                  var node2 = {
                    text: item2.find(".w-third-link").html(),
                    children: [],
                    ele: item2.find(".w-third-link"),
                  };
                  node1.children.push(node2);
                });
              });
            ...
            var _baseAdjuster$GetNavC3 = baseAdjuster.GetNavColor(
                self.ControlInfo.ControlView.find(".w-first-link"),
                self.ControlInfo.ControlView.find(".w-first-title")
              ),
    ...
    },
    {
      ...
      value: function SetCtrlCss_WideScreen() {
        switch (this.ControlInfo.StyleName) {
          case "Style1": {
            this.SetEleWidthAndHeightByAdjustControlInfo(
              this.ControlInfo.ControlView.find(".w-category")
            );
            this.SetEleWidthAndHeightByAdjustControlInfo(
              this.ControlInfo.ControlView.find("ul.w-category-list")
            );
            var rightWidth =
              CtrlAdjuster.GetCurrentBrowserWidth() -
              this.ControlInfo.ControlView[0].getBoundingClientRect().right;
            var listItems = this.ControlInfo.ControlView.find(
              ".w-category-list-item"
            );
            var self = this;
            listItems.toArray().forEach(function (li) {
              var liEle = $(li);
              var level =
                liEle.find(".w-category-listsecond").length +
                liEle.find(".w-category-listthird").length +
                1;

              var perWidth =
                rightWidth <
                self.ControlInfo.AdjustControlInfo.Width * (level - 1)
                  ? (rightWidth + self.ControlInfo.AdjustControlInfo.Width) /
                    level
                  : self.ControlInfo.AdjustControlInfo.Width;
              self.SetEleCss(liEle.find(".w-category-listsecond"), {
                width: perWidth + "px",
                left: perWidth + "px",
              });
              self.SetEleCss(liEle.find(".w-category-listthird"), {
                width: perWidth + "px",
                left: perWidth + "px",
              });
            });
          ...
          case "Style3": {
            this.SetEleWidthAndHeightByAdjustControlInfo(
              this.ControlInfo.ControlView.find(".w-classify")
            );
            var listItems =
              this.ControlInfo.ControlView.find(".w-classify-once");
            var self = this;
            listItems.toArray().forEach(function (li) {
              var liEle = $(li);
              self.SetEleCss(liEle.find(".w-classify-once-inner"), {
                left: self.ControlInfo.AdjustControlInfo.Width + "px",
              });
            });
            break;
          }
        ...
        if (this.ControlInfo.IsTemplateCtrl) {
          ...
          if (
            _get(
              ...
              "ShouldHideOriNav",
              this
            ).call(this, this.ControlInfo)
          ) {
            if (
              this.ControlInfo.ControlView.find(".slicknav_menu").length === 0
            ) {
              _get(
                categoryAdjuster.prototype.__proto__ ||
                  Object.getPrototypeOf(categoryAdjuster.prototype),
    ...
    },
    {
      ...
      value: function Reset2OriCss() {
        if (
          !this.ControlInfo.IsTemplateCtrl &&
          this.ControlInfo.ControlView.children().length === 2
        ) {
          this.ControlInfo.ControlView.children().eq(0).hide();
          this.ControlInfo.ControlView.children().eq(1).show();
        }
...
var commentAdjuster = (function (_baseAdjuster12) {
  ...
  function commentAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        commentAdjuster.__proto__ || Object.getPrototypeOf(commentAdjuster)
      ).call(this, controlInfo)
    );
  }
  ...
  _createClass(commentAdjuster, [
    {
      key: "GetHeight",
      value: function GetHeight() {
        return AdjustHelper.GetScrollHeight(
          this.ControlInfo.ControlView.find(".w-comment")
        );
      },
    },
    {
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        switch (this.ControlInfo.StyleName) {
          case "Style1": {
            this.SetEleCss(this.ControlInfo.ControlView.find(".w-comment"), {
              "min-width": "0px",
            });
            break;
          }
        ...
        _get(
          commentAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(commentAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
      },
...
var companyinfoAdjuster = (function (_fixMinZoomAs1Adjuste5) {
  ...
  function companyinfoAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        companyinfoAdjuster.__proto__ ||
        Object.getPrototypeOf(companyinfoAdjuster)
      ).call(this, controlInfo)
    );
  }
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        switch (this.ControlInfo.StyleName) {
          case "Style2": {
            this.SetEleCss(
              this.ControlInfo.ControlView.find(".companyinfo_Style2"),
              { overflow: "visible" }
            );
            break;
          }
          case "Style3": {
            this.SetEleCss(
              this.ControlInfo.ControlView.find(".company-info-text"),
        ...
        _get(
          companyinfoAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(companyinfoAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
      },
...
var companyIntroductionAdjuster = (function (_baseAdjuster13) {
  ...
  function companyIntroductionAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        companyIntroductionAdjuster.__proto__ ||
        Object.getPrototypeOf(companyIntroductionAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var favoritesAdjuster = (function (_baseAdjuster14) {
  ...
  function favoritesAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        favoritesAdjuster.__proto__ || Object.getPrototypeOf(favoritesAdjuster)
      ).call(this, controlInfo)
    );
  }
  ...
  _createClass(favoritesAdjuster, [
    {
      ...
      value: function SetCtrlCss() {
        switch (this.ControlInfo.StyleName) {
          case "Style1": {
            this.SetEleCss(this.ControlInfo.ControlView.find(".w-collection"), {
              width: "" + this.ControlInfo.AdjustControlInfo.Width,
            });
            break;
          }
        ...
        _get(
          favoritesAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(favoritesAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
      },
...
var languagesAdjuster = (function (_fixMinZoomAs1Adjuste6) {
  ...
  function languagesAdjuster(controlInfo) {
    ...
    var _this24 = _possibleConstructorReturn(
      this,
      (
        languagesAdjuster.__proto__ || Object.getPrototypeOf(languagesAdjuster)
      ).call(this, controlInfo)
    );
  ...
  _createClass(languagesAdjuster, [
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        switch (this.ControlInfo.StyleName) {
          ...
          case "Style2":
          case "Style3": {
            this.SetEleCss(this.ControlInfo.ControlView.find(".w-language"), {
              width: "" + this.ControlInfo.AdjustControlInfo.Width,
            });
            break;
          }
        ...
        _get(
          languagesAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(languagesAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
      },
    },
    {
      ...
      value: function Reset2OriCss() {
        switch (this.ControlInfo.StyleName) {
          case "Style1": {
            this.ControlInfo.ControlView.find(".w-language-dropdown").css(
              "display",
              ""
            );
            this.ControlInfo.ControlView.find(".w-language").off(
              "click",
              this.PrivateMethods.mobileClick
            );
...
var leavewordAdjuster = (function (_baseAdjuster15) {
  ...
  function leavewordAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        leavewordAdjuster.__proto__ || Object.getPrototypeOf(leavewordAdjuster)
      ).call(this, controlInfo)
    );
  }
  ...
  _createClass(leavewordAdjuster, [
    {
      ...
      value: function GetHiddenHeight(newWidth) {
        ...
        var newHeight = AdjustHelper.GetScrollHeight(
          this.ControlInfo.ControlView
        );
      ...
      value: function SetCtrlCss() {
        switch (this.ControlInfo.StyleName) {
          case "Style3": {
            //w-guestbook-table
            this.SetEleWidthAndHeightByAdjustControlInfo(
              this.ControlInfo.ControlView.find(".w-guestbook-table")
            );
            break;
          }
          case "Style6": {
            ...
            _get(
              leavewordAdjuster.prototype.__proto__ ||
                Object.getPrototypeOf(leavewordAdjuster.prototype),
              "ResetTag2OriCss",
              this
            ).call(this);
            this.SetEleWidthAndHeightByAdjustControlInfo(
              this.ControlInfo.ControlView.find(".w-guestbook")
            );
            this.SetEleCss(
              this.ControlInfo.ControlView.find(".w-guestbook-container"),
              { width: this.ControlInfo.AdjustControlInfo.Width + "px" }
            );
            this.SetEleCss(
              this.ControlInfo.ControlView.find(".w-guestbook-bottom"),
              { width: this.ControlInfo.AdjustControlInfo.Width + "px" }
            );
            var leftPart = this.ControlInfo.ControlView.find(
              ".w-guestbook-both-left"
            );
            var rightPart =
              this.ControlInfo.ControlView.find(".w-item-textarea");
            if (
              leftPart[0].getBoundingClientRect().y !==
              rightPart[0].getBoundingClientRect().y
            ) {
...
var listnewsAdjuster = (function (_baseAdjuster16) {
  ...
  function listnewsAdjuster(controlInfo) {
    ...
    var _this26 = _possibleConstructorReturn(
      this,
      (
        listnewsAdjuster.__proto__ || Object.getPrototypeOf(listnewsAdjuster)
      ).call(this, controlInfo)
    );
  ...
  _createClass(listnewsAdjuster, [
      ...
      value: function GetHeight() {
        ...
        var realHeight = this.PassHiddenCtrls(function (self) {
          switch (self.ControlInfo.StyleName) {
            ...
            case "listnewssearch_Style8": {
              var xnPagerHeight =
                self.ControlInfo.ControlView.find(".xn-pager").length === 1
                  ? AdjustHelper.GetScrollHeight(
                      self.ControlInfo.ControlView.find(".xn-pager")
                    ) + 40
                  : 0;

              return (
                AdjustHelper.GetScrollHeight(
                  self.ControlInfo.ControlView.find(".pager")
                ) +
                xnPagerHeight +
                AdjustHelper.GetScrollHeight(
                  self.ControlInfo.ControlView.find(".w-list")
                )
              );
              break;
            }
            ...
            case "Style8": {
              ...
              return (
                ...
                xnPagerHeight +
                AdjustHelper.GetScrollHeight(
                  self.ControlInfo.ControlView.find(".w-al-list")
                )
              );
            ...
            case "Style10": {
              var xnPagerHeight =
                self.ControlInfo.ControlView.find(".xn-pager").length === 1
                  ? AdjustHelper.GetScrollHeight(
                    ...
                    parseInt(
                      self.ControlInfo.ControlView.find(".xn-pager").css(
                        "marginTop"
                      )
                    )
                  : parseInt(
                      self.ControlInfo.ControlView.find(".m-list-arrow").css(
                        "marginTop"
                      )
                    ) +
                    parseInt(
              ...
              var listHeight = AdjustHelper.GetScrollHeight(
                self.ControlInfo.ControlView.find(".w-list")
              );
            ...
            default: {
              return _get(
                listnewsAdjuster.prototype.__proto__ ||
                  Object.getPrototypeOf(listnewsAdjuster.prototype),
                "GetDisplayHeight",
                _this27
              ).call(_this27);
              break;
    ...
    },
    {
      ...
      value: function SetSliderStyle(newWidth) {
        ...
        switch (this.ControlInfo.StyleName) {
          case "Style2": {
            LayoutConverter.ResetSlider(
              self.ControlInfo.CtrlId,
              newWidth,
              function () {
                //需要设置轮播的宽度 因为在样式文件中有设置
                self.SetEleCss(
                  self.ControlInfo.ControlView.find(".w-article"),
                  { width: newWidth + "px" }
                );
                self.SetEleCss(
                  self.ControlInfo.ControlView.find(".w-article-list"),
                  { width: newWidth + "px" }
                );
              }
            );
      ...
      value: function GetOriPicWidth() {
        if (this.OriPicWidth === null) {
          switch (this.ControlInfo.StyleName) {
            case "Style4": {
              this.OriPicWidth =
                this.ControlInfo.ControlView.find(".w-list-piclink").width();
              this.OriPicHeight =
                this.ControlInfo.ControlView.find(".w-list-piclink").height();
            ...
            case "Style7": {
              this.OriPicWidth =
                this.ControlInfo.ControlView.find(".w-al-pic").width();
              this.OriPicHeight =
                this.ControlInfo.ControlView.find(".w-al-pic").height();
              this.OriMarginLeft = AdjustHelper.GetCssPixelSize(
                this.ControlInfo.ControlView.find(".w-al-unit"),
                "margin-left"
              );
              break;
            }
            case "Style6": {
              this.OriPicWidth =
                this.ControlInfo.ControlView.find(".w-list-pic").width();
              this.OriPicHeight =
                this.ControlInfo.ControlView.find(".w-list-pic").height();
              this.OriMarginLeft = AdjustHelper.GetCssPixelSize(
                this.ControlInfo.ControlView.find(".w-list-item"),
                "margin-left"
              );
              break;
            }
            case "Style8": {
              this.OriPicWidth =
                this.ControlInfo.ControlView.find(".w-al-unit").width();
              this.OriPicHeight =
                this.ControlInfo.ControlView.find(".w-al-unit").height();
              this.OriMarginLeft = AdjustHelper.GetCssPixelSize(
                this.ControlInfo.ControlView.find(".w-al-unit"),
                "margin-left"
              );
        ...
        switch (this.ControlInfo.StyleName) {
          ...
          case "Style4": {
            if (
              ...
              var isPicHide =
                self.ControlInfo.ControlView.find(".w-list-pic")
                  .eq(0)
                  .css("display") === "none";
              ...
              if (newPicWidth < AdjustConfig.MinListPicWidth) {
                ...
                newPicHeight =
                  (newPicWidth / this.OriPicWidth) * this.OriPicHeight;
              }
              ...
              this.ControlInfo.ControlView.find(".w-list-item").each(function (
                a,
                b
              ) {
                var item = $(b);
                if (isPicHide) {
                  self.SetEleCss(item.find(".w-list-pic"), {
                    width: newPicWidth + "px",
                    height: newPicHeight + "px",
                  });
                  self.SetEleCss(item.find(".w-list-piclink"), {
                    width: newPicWidth + "px",
                    height: newPicHeight + "px",
                  });
                  self.SetEleCss(item.find(".w-listpic-in"), {
                    width: newPicWidth + "px",
                    height: newPicHeight + "px",
                    "margin-top": 0,
                    "margin-left": 0,
                  ...
                  self.SetEleCss(item.find(".w-list-r"), {
                    "padding-left": newPicWidth + "px",
                  });
          ...
          case "Style5": {
            if (
              ...
              this.ControlInfo.ControlView.find(".w-al-unit").each(function (
                a,
                b
              ) {
                var item = $(b);
                //padding-bottom是22
                self.SetEleCss(item.find(".w-al-pic"), {
                  width: newPicWidth + "px",
                  height: newPicHeight + "px",
                });
                self.SetEleCss(item.find("img"), {
                  width: newPicWidth + "px",
                  height: newPicHeight + "px",
                  "margin-top": 0,
                  "margin-left": 0,
                });
                self.SetEleCss(item.find(".w-al-pic>a"), {
                  width: newPicWidth + "px",
                  height: newPicHeight + "px",
                });
                self.SetEleCss(item.find(".w-al-r-in"), {
                  "margin-left": newPicWidth + "px",
                });
              });
            }
            break;
          ...
          case "Style6": {
            ...
            self.AdjustListItem(function (
              ...
              self.ControlInfo.ControlView.find(".w-list-item").each(function (
                a,
                b
              ) {
                var item = $(b);
                self.SetEleCss(item.find(".w-list-link"), {
                  width: newItemWidth + "px",
                });
                self.SetEleCss(item.find(".w-list-pic"), {
                  width: newItemWidth + "px",
                ...
                self.SetEleCss(item.find(".w-list-pic").find("img"), {
                  width: newItemWidth + "px",
                  height: newItemHeight + "px",
                  "margin-left": 0,
                  "margin-top": 0,
              ...
              self.SetEleCss(self.ControlInfo.ControlView.find(".w-list-ul"), {
                "margin-left": "-" + marginLeft + "px",
              });
            });
            break;
          ...
          case "Style7": {
            ...
            self.AdjustListItem(function (
              ...
              self.ControlInfo.ControlView.find(".w-al-unit").each(function (
                a,
                b
              ) {
                var item = $(b);
                ...
                self.SetEleCss(item.find(".w-al-pic").find("img"), {
                  width: newItemWidth + "px",
                  display: "block",
                  "margin-left": 0,
                  "margin-top": 0,
                ...
                self.SetEleCss(item.find(".w-al-text"), {
                  width: newItemWidth + "px",
                });
                self.SetEleCss(item, {
                  width: newItemWidth + "px",
              ...
              self.SetEleCss(self.ControlInfo.ControlView.find(".w-al-list"), {
                "margin-left": "-" + marginLeft + "px",
              });
            });
          ...
          case "listnewscategory_Style8": {
            ...
            self.AdjustListItem(function (
              ...
              self.ControlInfo.ControlView.find(".w-list-item").each(function (
                ...
                self.SetEleCss(item.find(".w-list-desc"), {
                  width: newItemWidth - 10 + "px",
                }); //-10px padding
                self.SetEleCss(item, {
                  width: newItemWidth + "px",
                  "margin-left":
                    (a % oneLineCount == 0 ? 0 : marginLeft) + "px",
                });
              });
            });
            break;
          ...
          case "Style10": {
            ...
            var self = this;
            if (
              CtrlAdjuster.GetCurrentBrowserWidth() >= CtrlAdjuster.OriPageWidth
            ) {
              this.SetEleCss(this.ControlInfo.ControlView.find(".w-list"), {
                left: "0px",
                width: CtrlAdjuster.OriPageWidth + "px",
              });
              this.SetEleCss(this.ControlInfo.ControlView.find(".w-list-ul"), {
                left: "0px",
                width: CtrlAdjuster.OriPageWidth + "px",
                margin: "auto",
              });
              this.SetEleCss(
                this.ControlInfo.ControlView.find(".list-wrapper"),
                {
                  left:
                    parseInt(
                      (this.ControlInfo.ControlView.find(".w-list").width() -
                        CtrlAdjuster.GetCurrentBrowserWidth()) /
                        2
                    ) + "px",
              ...
              this.SetEleCss(
                this.ControlInfo.ControlView.find(".m-list-arrow.u-left"),
                { left: "0px" }
              );
              this.SetEleCss(
                this.ControlInfo.ControlView.find(".m-list-arrow.u-right"),
                {
                  left:
                    this.ControlInfo.ControlView.find(
                      ".m-list-arrow.u-right"
                    ).width() +
                    16 +
                    "px",
                }
              ...
              this.SetEleCss(this.ControlInfo.ControlView.find(".w-list"), {
                left:
                  parseInt(CtrlAdjuster.GetCurrentBrowserWidth() * 0.1) + "px",
                width:
                  parseInt(CtrlAdjuster.GetCurrentBrowserWidth() * 0.9) + "px",
              });
              this.SetEleCss(this.ControlInfo.ControlView.find(".w-list-ul"), {
                left:
                  parseInt(CtrlAdjuster.GetCurrentBrowserWidth() * 0.1) + "px",
              ...
              this.SetEleCss(
                ...
                {
                  left:
                    -parseInt(CtrlAdjuster.GetCurrentBrowserWidth() * 0.1) +
                    "px",
                  width: CtrlAdjuster.GetCurrentBrowserWidth() + "px",
                }
              );
              ...
              this.SetEleCss(
                this.ControlInfo.ControlView.find(".m-list-arrow.u-right"),
                {
                  left:
                    parseInt(
                      CtrlAdjuster.GetCurrentBrowserWidth() * 0.1 +
                        this.ControlInfo.ControlView.find(
                          ".m-list-arrow.u-right"
                        ).width() +
                        16
              ...
              if (this.ControlInfo.ControlView.find(".xn-pager")[0]) {
                if (
                  this.ControlInfo.ControlView.find(".xn-pager").attr(
                    "jp-align"
                  ) == "left"
                ) {
                  console.log(
                  ...
                  if (
                    this.ControlInfo.ControlView.find(
                      ".xn-pager"
                    )[0].getBoundingClientRect().height > 30
                  ) {
                    this.SetEleCss(
                      this.ControlInfo.ControlView.find(".xn-pager"),
                      {
                        marginTop:
                          this.ControlInfo.ControlView.find(
                            ".m-list-arrow.u-right"
                  ...
                  if (
                    ...
                    this.SetEleCss(
                      this.ControlInfo.ControlView.find(".xn-pager"),
                      { marginTop: "20px", marginLeft: "160px" }
                    );
                  }
                }
                if (
              ...
              if (CtrlAdjuster.IsMobile) {
                this.ControlInfo.ControlView.find(".w-list").addClass(
                  "mobileState"
                );
              } else {
                this.ControlInfo.ControlView.find(".w-list").removeClass(
                  "mobileState"
                );
              }
...
var listnewscategoryAdjuster = (function (_listnewsAdjuster) {
  ...
  function listnewscategoryAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        listnewscategoryAdjuster.__proto__ ||
        Object.getPrototypeOf(listnewscategoryAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var listnewssearchAdjuster = (function (_listnewsAdjuster2) {
  ...
  function listnewssearchAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        listnewssearchAdjuster.__proto__ ||
        Object.getPrototypeOf(listnewssearchAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var listproductAdjuster = (function (_baseAdjuster17) {
  ...
  function listproductAdjuster(controlInfo) {
    ...
    var _this30 = _possibleConstructorReturn(
      this,
      (
        listproductAdjuster.__proto__ ||
        Object.getPrototypeOf(listproductAdjuster)
      ).call(this, controlInfo)
    );
    ...
    _this30.BaseSetCtrlCss = _get(
      listproductAdjuster.prototype.__proto__ ||
        Object.getPrototypeOf(listproductAdjuster.prototype),
      "SetCtrlCss",
      _this30
    );
    return _this30;
  ...
  _createClass(listproductAdjuster, [
    ...
    },
    {
      key: "Reset2OriCss",
      value: function Reset2OriCss() {
        this.ControlInfo.ControlView.find(".DisableCutFill")
          .removeClass("NoCutFill")
          .removeClass("DisableCutFill");
        switch (this.ControlInfo.StyleName) {
          case "Style3":
          case "Style4": {
            this.GetOriPicWidth();
    ...
    },
    {
      ...
      value: function GetHeight() {
        ...
        //避免有动效取高度的时候动效还没执行完导致高度取的异常
        var notransitionDom =
          this.ControlInfo.ControlView.find("li,.w-list-desc");
        ...
        var realHeight = this.PassHiddenCtrls(function (self) {
          switch (_this31.ControlInfo.StyleName) {
            ...
            case "Style3":
            case "Style4": {
              return AdjustHelper.GetCssPixelSize(
                self.ControlInfo.ControlView.find(".w-list-item"),
                "height"
              ); //todo
            }
            default: {
    ...
    },
    {
      ...
      value: function GetArrowWidth() {
        return (
          AdjustHelper.GetCssPixelSize(
            this.ControlInfo.ControlView.find(".m-list-arrow"),
            "width"
          ) + 5
        );
      },
      ...
      value: function SetSliderStyle(ctrlWidth) {
        ...
        LayoutConverter.ResetSlider(
          ...
          function (jssorCache) {
            ...
            self.ControlInfo.ControlView.find(".w-list-pic>img").each(function (
              a,
              b
            ) {
            ...
            if (picwidth + spacingwidth > 0) {
              var tempCount =
                (ctrlWidth - picwidth) / (picwidth + spacingwidth) + 1;
              totalcount = tempCount > totalcount ? tempCount : totalcount;
            }
            totalcount =
              totalcount < listEles.length ? totalcount : listEles.length;
            jssorCache.JssorOpt.$Cols = totalcount;
            self.ControlInfo.ControlView.find(".w-list-ul").each(function (
              a,
              b
            ) {
            ...
            if (jssorCache.JssorOpt.$SlideWidth > ctrlWidth) {
              ...
              self.ControlInfo.ControlView.find(".w-list-pic>img").each(
                function (a, b) {
        ...
        switch (this.ControlInfo.StyleName) {
          case "Style1": {
            ...
            this.ControlInfo.ControlView.find(".w-list-item").each(function (
              ...
              self.SetEleCss(item, {
                width: self.ControlInfo.AdjustControlInfo.Width + "px",
                height: newPicHeight + "px",
                "margin-left": 0,
              });
              self.SetEleCss(item.find(".w-list-r"), {
          ...
          case "productRelateBind_Style2": {
            ...
            self.AdjustListItem(function (
              ...
              self.ControlInfo.ControlView.find(".w-list-item").each(function (
                ...
                item
                  .find(".w-list-pic")
                  .find("img:not(.NoCutFill)")
                  .addClass("NoCutFill")
                  .addClass("DisableCutFill");
                self.SetEleCss(item, {
                  width: newItemWidth - borderWidth + "px",
                  "margin-left":
                    (a % oneLineCount == 0 ? 0 : marginLeft) + "px",
                });
              });
          ...
          case "Style4": {
            ...
            var width =
              this.ControlInfo.AdjustControlInfo.Width - arrowWidth * 2;
          ...
          case "Style5": {
            ...
            self.AdjustListItem(function (
              ...
              _this32.ControlInfo.ControlView.find(".w-list-item").each(
                function (a, b) {
                  var item = $(b);
                  var linkItem = item.find(".w-list-link");
                  var linkPadding = AdjustHelper.GetCssPixelSize(
                    linkItem,
                    "padding"
                  );
                  self.SetEleCss(item.find(".w-list-pic"), {
                    ...
                    width:
                      newItemWidth -
                      AdjustHelper.GetCssPixelSize(linkItem, "padding-left") *
                        2 +
                      "px",
                  });
                  self.SetEleCss(item.find(".w-list-pic>img"), {
                    height: newItemHeight + "px",
                    width:
                      newItemWidth -
                      AdjustHelper.GetCssPixelSize(linkItem, "padding-left") *
                  ...
                  self.SetEleCss(item.find(".w-list-bottom"), {
                    width: newItemWidth - linkPadding * 2 + "px",
                  });
                  self.SetEleCss(linkItem, {
                    width: newItemWidth - linkPadding * 2 + "px",
                  });
                  self.SetEleCss(item, {
                    width: newItemWidth + "px",
              ...
              _this32.SetEleCss(
                _this32.ControlInfo.ControlView.find(".w-list-ul"),
                { "margin-left": 0 }
              );
            });
            break;
...
var listproductcategoryAdjuster = (function (_listproductAdjuster) {
  ...
  function listproductcategoryAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        listproductcategoryAdjuster.__proto__ ||
        Object.getPrototypeOf(listproductcategoryAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var listproductsearchAdjuster = (function (_listproductcategoryA) {
  ...
  function listproductsearchAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        listproductsearchAdjuster.__proto__ ||
        Object.getPrototypeOf(listproductsearchAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var loginAdjuster = (function (_baseAdjuster18) {
  ...
  function loginAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (loginAdjuster.__proto__ || Object.getPrototypeOf(loginAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(loginAdjuster, [
    {
      key: "SetCtrlCss",
      value: function SetCtrlCss() {
        this.SetEleCss(this.ControlInfo.ControlView.find(".w-login"), {
          width: "" + this.ControlInfo.AdjustControlInfo.Width,
        });

        _get(
          loginAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(loginAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
      },
...
var navAdjuster = (function (_baseAdjuster19) {
  ...
  function navAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (navAdjuster.__proto__ || Object.getPrototypeOf(navAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(navAdjuster, [
    {
      ...
      value: function GetHiddenHeight() {
        switch (this.ControlInfo.StyleName) {
          ...
          case "Style7": {
            this.SetCtrlCss();
            var height = AdjustHelper.GetScrollHeight(
              this.ControlInfo.ControlView
            );
            this.ResetTag2OriCss();
            return height;
    ...
    },
    {
      ...
      value: function HundredPercentHandler() {
        if (
          ...
          _get(
            navAdjuster.prototype.__proto__ ||
              Object.getPrototypeOf(navAdjuster.prototype),
            "HundredPercentHandler",
            this
          ).call(this);
        }
      ...
      value: function GetNavInfo() {
        ...
        switch (this.ControlInfo.StyleName) {
          ...
          case "Style11": {
            ...
            var _baseAdjuster$GetNavC4 = baseAdjuster.GetNavColor(
                self.ControlInfo.ControlView.find(".w-nav-item-link"),
                self.ControlInfo.ControlView.find(".w-nav-inner")
              ),
          ...
          case "Style13": {
            ...
            var _baseAdjuster$GetNavC5 = baseAdjuster.GetNavColor(
                self.ControlInfo.ControlView.find(".w-nav-item-link"),
                self.ControlInfo.ControlView.find(".w-nav")
              ),
          ...
          case "Style12": {
            ...
            firstNode.each(function (a, b) {
              var item = $(b);
              var node0 = {
                text: item.find("a").eq(0).html(),
                children: [],
                ele: item.find("a").eq(0),
              };
            ...
            var _baseAdjuster$GetNavC6 = baseAdjuster.GetNavColor(
                self.ControlInfo.ControlView.find(".w-nav-item>a"),
                self.ControlInfo.ControlView.find(".w-nav-item>a")
              ),
    ...
    },
    {
      ...
      value: function SetCtrlCss_WideScreen() {
        ...
        switch (this.ControlInfo.StyleName) {
          case "Style1": {
            this.SetEleWidthAndHeightByAdjustControlInfo(
              this.ControlInfo.ControlView.find(".w-nav")
            );
            //var self = this;
          ...
          case "Style7": {
            ...
            //})
            var self = this;
            this.ControlInfo.ControlView.find(".w-subnav").each(function (
              a,
              b
            ) {
              self.SetEleCss($(b), {
          ...
          case "Style5":
          case "Style6": {
            this.SetEleCss(this.ControlInfo.ControlView.find(".sliding-box"), {
              width: this.ControlInfo.AdjustControlInfo.Width + "px",
            });
            //var self = this;
            //var width = this.ControlInfo.ControlView.find(".w-nav-inner").width();
...
var navcontainerAdjuster = (function (_baseAdjuster20) {
  ...
  function navcontainerAdjuster(controlInfo) {
    ...
    var _this37 = _possibleConstructorReturn(
      this,
      (
        navcontainerAdjuster.__proto__ ||
        Object.getPrototypeOf(navcontainerAdjuster)
      ).call(this, controlInfo)
    );

    _this37.LogoPercent = AdjustHelper.ToFixed(
      (_this37.ControlInfo.ControlView.find(".logo-area").attr("data-width") *
        1) /
        100,
      3
    );
    _this37.NavPercent = AdjustHelper.ToFixed(
      (_this37.ControlInfo.ControlView.find(".nav-area").attr("data-width") *
        1) /
        100,
      3
    );
  ...
  _createClass(navcontainerAdjuster, [
    {
      ...
      value: function Reset2OriCss() {
        ...
        this.ControlInfo.ControlView.find(".logo-area").css({
          width: width * this.LogoPercent + "px",
        });
        this.ControlInfo.ControlView.find(".nav-area").css({
          width: width * this.NavPercent + "px",
        });
        var self = this;
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        _get(
          navcontainerAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(navcontainerAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
        var areaWidth = AdjustHelper.ToFixed(
          this.ControlInfo.AdjustControlInfo.Width * this.NavPercent
        );

        this.SetEleCss(this.ControlInfo.ControlView.find(".logo-area"), {
          width:
            AdjustHelper.ToFixed(
              this.ControlInfo.AdjustControlInfo.Width * this.LogoPercent
            ) + "px",
        });
        ...
        var currentItemWidth = AdjustHelper.ToFixed(
          areaWidth / items.length,
          0
        );
        items.each(function (a, b) {
          self.SetEleCss($(b), {
            "min-width": "0",
            width:
              (currentItemWidth < self.OriItemWidth
                ? currentItemWidth
                : self.OriItemWidth) + "px",
          });
        });
...
var newsItemContentBindAdjuster = (function (_baseAdjuster21) {
  ...
  function newsItemContentBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        newsItemContentBindAdjuster.__proto__ ||
        Object.getPrototypeOf(newsItemContentBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var newsItemCrumbsBindAdjuster = (function (_baseAdjuster22) {
  ...
  function newsItemCrumbsBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        newsItemCrumbsBindAdjuster.__proto__ ||
        Object.getPrototypeOf(newsItemCrumbsBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var newsItemNextBindAdjuster = (function (_fixMinZoomAs1Adjuste7) {
  ...
  function newsItemNextBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        newsItemNextBindAdjuster.__proto__ ||
        Object.getPrototypeOf(newsItemNextBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var newsItemPreviousBindAdjuster = (function (_fixMinZoomAs1Adjuste8) {
  ...
  function newsItemPreviousBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        newsItemPreviousBindAdjuster.__proto__ ||
        Object.getPrototypeOf(newsItemPreviousBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var newsItemHitsBindAdjuster = (function (_fixMinZoomAs1Adjuste9) {
  ...
  function newsItemHitsBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        newsItemHitsBindAdjuster.__proto__ ||
        Object.getPrototypeOf(newsItemHitsBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var newsItemSummaryBindAdjuster = (function (_baseAdjuster23) {
  ...
  function newsItemSummaryBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        newsItemSummaryBindAdjuster.__proto__ ||
        Object.getPrototypeOf(newsItemSummaryBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var newsItemTitleBindAdjuster = (function (_baseAdjuster24) {
  ...
  function newsItemTitleBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        newsItemTitleBindAdjuster.__proto__ ||
        Object.getPrototypeOf(newsItemTitleBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var productCategoryCrumbsAdjuster = (function (_newsItemCrumbsBindAd) {
  ...
  function productCategoryCrumbsAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        productCategoryCrumbsAdjuster.__proto__ ||
        Object.getPrototypeOf(productCategoryCrumbsAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var productCrumbsBindAdjuster = (function (_newsItemCrumbsBindAd2) {
  ...
  function productCrumbsBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        productCrumbsBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productCrumbsBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var productContentBindAdjuster = (function (_newsItemContentBindA) {
  ...
  function productContentBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        productContentBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productContentBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var productCurrentPriceBindAdjuster = (function (_baseAdjuster25) {
  ...
  function productCurrentPriceBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        productCurrentPriceBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productCurrentPriceBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var productHitsBindAdjuster = (function (_newsItemHitsBindAdju) {
  ...
  function productHitsBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        productHitsBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productHitsBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var productNextBindAdjuster = (function (_newsItemNextBindAdju) {
  ...
  function productNextBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        productNextBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productNextBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var productPreviousBindAdjuster = (function (_newsItemPreviousBind) {
  ...
  function productPreviousBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        productPreviousBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productPreviousBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var productOriginalPriceBindAdjuster = (function (_baseAdjuster26) {
  ...
  function productOriginalPriceBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        productOriginalPriceBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productOriginalPriceBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var productParameterBindAdjuster = (function (_baseAdjuster27) {
  ...
  function productParameterBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        productParameterBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productParameterBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var productRelateBindAdjuster = (function (_listproductAdjuster2) {
  ...
  function productRelateBindAdjuster(controlInfo) {
    ...
    var _this54 = _possibleConstructorReturn(
      this,
      (
        productRelateBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productRelateBindAdjuster)
      ).call(this, controlInfo)
    );
  ...
  _createClass(productRelateBindAdjuster, [
    {
      ...
      value: function SetWidthAndHeight(newWidth) {
        ...
        if (this.IsJssorSlide) {
          ...
          var jssorCache = LayoutConverter.CtrlJsVariableList.find(function (
            i
          ) {
          ...
          this.ControlInfo.ControlView.find('[data-scale-ratio="1"]').css(
            "left",
            0
          );
          ...
          _get(
            productRelateBindAdjuster.prototype.__proto__ ||
              Object.getPrototypeOf(productRelateBindAdjuster.prototype),
            "SetWidthAndHeight",
            this
          ).call(this, newWidth);
        }
...
var productSlideBindAdjuster = (function (_baseAdjuster28) {
  ...
  function productSlideBindAdjuster(controlInfo) {
    ...
    var _this55 = _possibleConstructorReturn(
      this,
      (
        productSlideBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productSlideBindAdjuster)
      ).call(this, controlInfo)
    );
    ...
    switch (_this55.ControlInfo.StyleName) {
      case "Style3": {
        ...
        _this55.OriMainPicHeight = _this55.ControlInfo.ControlView.find(
          ".w-slider"
        )
          .children()
          .eq(0)
          .height();
        _this55.OriThumbHeight = _this55.ControlInfo.ControlView.find(
          '[data-u="thumbnavigator"]'
        )
          .eq(0)
          .height();
        _this55.OriThumbWidth = _this55.ControlInfo.ControlView.find(
          '[data-u="thumb"]'
        )
          .eq(0)
          .width();
  ...
  _createClass(productSlideBindAdjuster, [
      ...
      value: function SetWidthAndHeight(newWidth) {
        switch (this.ControlInfo.StyleName) {
          case "Style3": {
            ...
            this.ControlInfo.AdjustControlInfo.Width = newWidth;
            this.ControlInfo.AdjustControlInfo.Height =
              this.OriMainPicHeight * zoomVal + this.OriThumbHeight;
            break;
          }
          case "Style4": {
            this.AppendTips("设置宽高:等比缩放");
          ...
          default: {
            return _get(
              productSlideBindAdjuster.prototype.__proto__ ||
                Object.getPrototypeOf(productSlideBindAdjuster.prototype),
              "SetWidthAndHeight",
              this
            ).call(this, newWidth);
          }
    ...
    },
    {
      ...
      value: function SetSliderStyle(newWidth, newHeight, isReset) {
        var self = this;
        var navLength =
          self.ControlInfo.ControlView.find(".w-point-item").length;
        LayoutConverter.ResetSlider(
          this.ControlInfo.CtrlId,
          null,
          function (jssorCache) {
            switch (self.ControlInfo.StyleName) {
              case "Style3": {
                if (self.OriPicWidth === undefined) {
                  var img =
                    self.ControlInfo.ControlView.find('[data-u="image"]').eq(0);
                ...
                self.SetEleCss(
                  self.ControlInfo.ControlView.find(".w-bigimglist"),
                  { width: newWidth + "px", height: mainPicHeight + "px" }
                );
                self.SetEleCss(self.ControlInfo.ControlView, {
                  width: newWidth + "px",
                  height: totalHeight + "px",
                });
                self.SetEleCss(self.ControlInfo.ControlView.find(".w-slider"), {
                  width: newWidth + "px",
                  height: totalHeight + "px",
                });
                ...
                var shouldAdjustTextAlign =
                  self.FillType === "Auto" ||
                  self.ControlInfo.ControlView.find("script")
                    .eq(0)
                    .text()
                    .indexOf("var fillType = 'Auto';") !== -1;
                if (shouldAdjustTextAlign) {
                  window.setTimeout(function () {
                    ...
                    self.SetEleCss(
                      self.ControlInfo.ControlView.find(".w-bigimglist img"),
                      {
                        width: "auto",
                        height: "auto",
                        position: "static",
                ...
                var hasZoomEffect =
                  self.ControlInfo.ControlView.find(".jqueryzoom").length > 0;
                if (!CtrlAdjuster.IsMobile && hasZoomEffect) {
                  $("#" + self.ControlInfo.CtrlId + "_w-slider3")
                    .find(".jqueryzoom")
                    .jqueryzoom({
                      xzoom: 400,
                      yzoom: 400,
              ...
              case "Style4": {
                ...
                if (
                  navWidth >
                  self.ControlInfo.AdjustControlInfo.ParentWidthSubPadding
                ) {
                  self.ControlInfo.ControlView.find(".w-point-item").css(
                    "width",
                    parseInt(
                      self.ControlInfo.AdjustControlInfo.ParentWidthSubPadding /
                        navLength -
                ...
                self.ControlInfo.ControlView.find(".w-slider").height(
                  newHeight
                );

                self.ControlInfo.ControlView.find(".w-slider-wrap").width(
                  newWidth
                );
                self.ControlInfo.ControlView.find(".w-slider-wrap").height(
                  newHeight
                );

                self.ControlInfo.ControlView.find(".w-slider-title").width(
                  newWidth
                );

                self.ControlInfo.ControlView.find(".w-slider-titlein").width(
                  newWidth
                );

                setTimeout(function () {
                  var bigImgWidth =
                    self.ControlInfo.ControlView.attr("oripicwidth") * 1;
                  if (bigImgWidth) {
                    $(
                      "#slider_smv_" + self.ControlInfo.CtrlId + " .w-imglink"
            ...
            switch (self.ControlInfo.StyleName) {
              case "Style3": {
                self.SetEleCss(
                  ...
                  { width: newWidth + "px", left: 0 }
                );
                var thumbnavigator = self.ControlInfo.ControlView.find(
                  '[data-u="thumbnavigator"]'
                )
                  .children()
                  .eq(0);
              ...
              case "Style4": {
                ...
                if (!bigImgWidth) {
                  $(
                    "#slider_smv_" + self.ControlInfo.CtrlId + " .w-imglink img"
                  ).cutFill(newWidth - 2, newHeight - 2);
                }
                break;
              }
            }
...
var productSummaryBindAdjuster = (function (_newsItemSummaryBindA) {
  ...
  function productSummaryBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        productSummaryBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productSummaryBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var productTitleBindAdjuster = (function (_newsItemTitleBindAdj) {
  ...
  function productTitleBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        productTitleBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productTitleBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var productSpecificationsBindAdjuster = (function (_baseAdjuster29) {
  ...
  function productSpecificationsBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        productSpecificationsBindAdjuster.__proto__ ||
        Object.getPrototypeOf(productSpecificationsBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var registerAdjuster = (function (_baseAdjuster30) {
  ...
  function registerAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        registerAdjuster.__proto__ || Object.getPrototypeOf(registerAdjuster)
      ).call(this, controlInfo)
    );
  }
  ...
  _createClass(registerAdjuster, [
    {
      ...
      value: function SetCtrlCss() {
        _get(
          registerAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(registerAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
        this.SetEleWidthAndHeightByAdjustControlInfo(
          this.ControlInfo.ControlView.find(".w-register")
        );
      },
    },
  ]);
...
var searchAdjuster = (function (_baseAdjuster31) {
  ...
  function searchAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (searchAdjuster.__proto__ || Object.getPrototypeOf(searchAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(searchAdjuster, [
    {
      ...
      value: function SetCtrlCss() {
        _get(
          searchAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(searchAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
        switch (this.ControlInfo.StyleName) {
...
var shareAdjuster = (function (_baseAdjuster32) {
  ...
  function shareAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (shareAdjuster.__proto__ || Object.getPrototypeOf(shareAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(shareAdjuster, [
    {
      ...
      value: function GetHiddenHeight(newWidth) {
        ...
        ele.css({ width: newWidth });
        this.ControlInfo.ControlView.find(".bdsharebuttonbox").css({
          width: newWidth,
        });
        var newHeight = AdjustHelper.GetScrollHeight(
          ele.find(".bdsharebuttonbox")
        );
        ele.css(oriCss);
        this.ControlInfo.ControlView.find(".bdsharebuttonbox").css({
          width: this.ControlInfo.Width,
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        _get(
          shareAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(shareAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
...
var slideAdjuster = (function (_baseAdjuster33) {
  ...
  function slideAdjuster(controlInfo) {
    ...
    var _this62 = _possibleConstructorReturn(
      this,
      (slideAdjuster.__proto__ || Object.getPrototypeOf(slideAdjuster)).call(
        this,
        controlInfo
      )
    );
    ...
    switch (_this62.ControlInfo.StyleName) {
      case "Style3": {
        _this62.OriMainPicHeight = _this62.ControlInfo.ControlView.find(
          ".w-slider"
        )
          .children()
          .eq(0)
          .height();
        _this62.OriThumbHeight = _this62.ControlInfo.ControlView.find(
          '[data-u="thumbnavigator"]'
        )
          .eq(0)
          .height();
        _this62.OriThumbWidth = _this62.ControlInfo.ControlView.find(
          '[data-u="thumb"]'
        )
          .eq(0)
          .width();
      ...
      value: function Reset2OriCss() {
        switch (this.ControlInfo.StyleName) {
          case "Style1": {
            ...
            this.ControlInfo.ControlView.css(
              "left",
              -(
                CtrlAdjuster.GetCurrentBrowserWidth() -
                CtrlAdjuster.OriPageWidth
    ...
    },
    {
      ...
      value: function SetWidthAndHeight(newWidth) {
        switch (this.ControlInfo.StyleName) {
          case "Style6": {
            _get(
              slideAdjuster.prototype.__proto__ ||
                Object.getPrototypeOf(slideAdjuster.prototype),
              "SetWidthAndHeight_JustWidth",
              this
            ).call(this, newWidth);
            break;
          }
      ...
      value: function SetSliderStyle(newWidth, newHeight, isReset) {
        ...
        LayoutConverter.ResetSlider(
          ...
          function (jssorCache) {
            switch (self.ControlInfo.StyleName) {
              case "Style1": {
                ...
                _this63.SetEleCss(
                  self.ControlInfo.ControlView.find(".w-slider"),
                  {
                    width: screenWidth + "px",
                    height: newHeight + "px",
                    left: 0,
                ...
                _this63.SetEleCss(
                  self.ControlInfo.ControlView.find(".w-slider-wrap"),
                  {
                    width: screenWidth + "px",
                    height: newHeight + "px",
                    left: 0,
              ...
              case "Style3": {
                ...
                setTimeout(function () {
                  ...
                  if (bigImgWidth && newWidth > 264) {
                    var bigImgHeight =
                      self.ControlInfo.ControlView.attr("oripicheight") * 1;
                    self.ControlInfo.ControlView.find(
                      ".w-bigimglist img"
                    ).cutFill(bigImgWidth, bigImgHeight);
                    self.ControlInfo.ControlView.find(".w-bigimglist img").each(
                      function (a, b) {
              ...
              case "Style4": {
                self.ControlInfo.ControlView.css({
                  width: newWidth + "px",
                  height: newHeight + "px",
                });
                self.ControlInfo.ControlView.find(".w-slider").css({
                  width: newWidth + "px",
                  height: newHeight + "px",
                });
                self.ControlInfo.ControlView.find(".w-slider-wrap").css({
                  width: newWidth + "px",
                  height: newHeight + "px",
                });
                self.ControlInfo.ControlView.find(".w-slider-title").css({
                  width: newWidth + "px",
                });
                self.ControlInfo.ControlView.find(".w-slider-titlein").css({
                  width: newWidth + "px",
                });
                ...
                setTimeout(function () {
                  ...
                  if (bigImgWidth && newWidth > 264) {
                    var bigImgHeight =
                      self.ControlInfo.ControlView.attr("oripicheight") * 1;
                    self.ControlInfo.ControlView.find(".w-imglink img").cutFill(
                      bigImgWidth,
                      bigImgHeight
                    );
                    self.ControlInfo.ControlView.find(".w-imglink img").each(
                      function (a, b) {
                        $(b).css("left", (newWidth - bigImgWidth) / 2 + "px");
                      }
                    );
              ...
              case "Style5": {
                ...
                _this63.SetEleCss(
                  self.ControlInfo.ControlView.find(".w-slider"),
                  { width: newWidth + "px", height: totalHeight + "px" }
                );
                _this63.SetEleCss(
                  self.ControlInfo.ControlView.find(".w-slider-wrap"),
                  { width: newWidth + "px", height: mainPicHeight + "px" }
              ...
              case "Style7": {
                ...
                if (!isReset) {
                  _this63.SetEleCss(
                    self.ControlInfo.ControlView.find(".w-thumb-p"),
                    {
                      width:
                        _this63.OriThumbWidth *
                          _get(
                            slideAdjuster.prototype.__proto__ ||
                              Object.getPrototypeOf(slideAdjuster.prototype),
                            "CurrentZoomVal",
                  ...
                  _this63.SetEleCss(
                    self.ControlInfo.ControlView.find(".w-thumb-p"),
                    {
                      width: _this63.OriThumbWidth + "px",
                      height: (thumbHeight = _this63.OriThumbHeight) + "px",
                    }
                  );
                }
                _this63.SetEleCss(
                  self.ControlInfo.ControlView.find(".w-thumb-bg"),
                  { width: newWidth + "px", height: thumbHeight + 20 + "px" }
                );
                _this63.SetEleCss(
                  self.ControlInfo.ControlView.find(
                    '[data-u="arrowleft"],[data-u="arrowright"]'
                  ),
                  { bottom: (thumbHeight + 20) / 2 - 17 + "px" }
                );
                _this63.SetEleCss(self.ControlInfo.ControlView, {
                  width: newWidth + "px",
                  height: newHeight + "px",
                ...
                _this63.ControlInfo.ControlView.find(".w-thumb-s").css(
                  "max-width",
                  newWidth - 100 + "px"
                );
                break;
          ...
          function (jssorCache) {
            switch (self.ControlInfo.StyleName) {
              case "Style2": {
                $("#slider_smv_" + _this63.ControlInfo.CtrlId + " img").cutFill(
                  newWidth,
                  newHeight
                );
                break;
              ...
              case "Style3": {
                ...
                self.SetEleCss(
                  self.ControlInfo.ControlView.find('[data-u="thumbnavigator"]')
                    .children()
                    .eq(0),
                  { left: 0 }
                );
              ...
              case "Style4": {
                if (jssorCache.FillType !== "Auto") {
                  var imgList =
                    self.ControlInfo.ControlView.find(".w-imglink img");
                  imgList.cutFill(
                    self.ControlInfo.AdjustControlInfo.Width,
                    self.ControlInfo.AdjustControlInfo.Height
                  );
                }
                //当底部切换按钮设置为隐藏时,需要将父级也隐藏,避免手机端可以左右滑动显示空白
                var navigator =
                  self.ControlInfo.ControlView.find("[data-u=navigator]");
              ...
              case "Style5": {
                ...
                $(identityFlag + " .w-thumb-t img").cutFill(
                  thunWidth,
                  thunHeight
                );
                break;
...
var slidesetAdjuster = (function (_baseAdjuster34) {
  ...
  function slidesetAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        slidesetAdjuster.__proto__ || Object.getPrototypeOf(slidesetAdjuster)
      ).call(this, controlInfo)
    );
  }
  ...
  _createClass(slidesetAdjuster, [
    ...
    },
    {
      ...
      value: function SetWidthAndHeight_MatchMaxHeight(newWidth) {
        ...
        var virAreaCtrlIdList = CtrlAdjuster.StaticCtrlList.filter(function (
          i
        ) {
        ...
        if (maxBottom > zoomHeight) {
          ...
          _get(
            slidesetAdjuster.prototype.__proto__ ||
              Object.getPrototypeOf(slidesetAdjuster.prototype),
            "SetWidthAndHeight_ZoomHeight",
            this
          ).call(this, newWidth);
        }
        ...
        switch (this.ControlInfo.StyleName) {
          ...
          case "Style3": {
            ...
            var ctrlIdList = CtrlAdjuster.StaticCtrlList.filter(function (i) {
              return (
                !i.IsVirtualCtrl && i.RealParentId === self.ControlInfo.CtrlId
              );
            }).map(function (i) {
              return i.CtrlId;
            });
            ...
            //先获取调节后的ControlView
            var existingCtrlList = CtrlAdjuster.StaticCtrlList.filter(function (
              i
            ) {
              ...
              return {
                CtrlId: i.CtrlId,
                ControlView: i.ControlView,
                ParentId: i.ParentId,
                RealParentId: i.RealParentId,
                AreaId: i.AreaId,
                ElementId: i.ElementId,
              };
            });
            $(document.body).append(
              "<div id='hiddenCtrlHolder' style='display:none'></div>"
            );
            ...
            LayoutConverter.ResetSlider(
              ...
              function () {
                ...
                self.ControlInfo.ControlView.find("[pvid]").each(function (
                  a,
                  b
                ) {
                  var ele = $(b);
                  ...
                  if (
                    goneCtrl == null ||
                    ele.attr("pvid") != goneCtrl.RealParentId
                  ) {
                    ele.remove();
                  }
                });
                  ...
                  .each(function (a, b) {
                    var existingCtrl = existingCtrlList.find(function (i) {
                      return (
                        ...
                        b.id
                          .replace("smv_", "")
                          .replace(AdjustConfig.TempIdSuffix, "")
                      );
                    });
                    if (existingCtrl) {
                      ...
                      //})
                      self.ControlInfo.ControlView.find(".animated").smanimate(
                        "stop"
                      );

                      self.ControlInfo.ControlView.find(
                        "#" + existingCtrl.ElementId
                      ).remove();
                      self.ControlInfo.ControlView.find(
                        "#smc_" +
                          existingCtrl.AreaId +
                          "[cid=" +
                          existingCtrl.RealParentId +
                          "]"
                      ).append(existingCtrl.ControlView);
                    }
                  });

                self.ControlInfo.ControlView.find(
                  "[id$='" + AdjustConfig.TempIdSuffix + "']"
                ).each(function (a, b) {
            ...
            self.ControlInfo.ControlView.find(".content-box-inner").each(
              function (a, b) {
                b.style.setProperty("height", height + "px", "important");
              }
            );
              ...
              function () {
                ...
                $("#hiddenCtrlHolder")
                  ...
                  .each(function (a, b) {
                    ...
                    if (existingCtrl) {
                      self.RemoveAnimated(existingCtrl.ControlView);
                      existingCtrl.ControlView.find("[ctype]").each(function (
                        a,
                        b
                      ) {
                        self.RemoveAnimated($(b));
...
var tabAdjuster = (function (_baseAdjuster35) {
  ...
  function tabAdjuster(controlInfo) {
    ...
    var _this66 = _possibleConstructorReturn(
      this,
      (tabAdjuster.__proto__ || Object.getPrototypeOf(tabAdjuster)).call(
        this,
        controlInfo
      )
    );
    ...
    _this66.ControlInfo.ControlView.attr(
      "lastHeight",
      _this66.ControlInfo.Height
    );
    switch (_this66.ControlInfo.StyleName) {
      case "Style1":
      case "Style2":
      case "Style7": {
        _this66.TabTitleHeight = _this66.ControlInfo.ControlView.find(
          "li.w-label-tips-item[data-area]"
        )
          .eq(0)
          .height();
        break;
      ...
      case "Style10":
      case "Style11": {
        _this66.OriginalHeight = _this66.ControlInfo.ControlView.children()
          .find(">.w-label")
          .height();
        break;
      }
  ...
  _createClass(tabAdjuster, [
      ...
      value: function CalculateMultiContainerHeight() {
        ...
        for (var areaId in areaMap) {
          var maxBottom = Math.max.apply(
            Math,
            areaMap[areaId].map(function (ctrl) {
              return (
                ctrl.AdjustControlInfo.Bottom + AdjustConfig.MinCtrlYPadding
              );
            })
          );
          var contentArea = this.ControlInfo.ControlView.find(
            '.w-label>.w-label-content>li[data-area="' + areaId + '"]>.smAreaC'
          );
    ...
    },
    {
      ...
      value: function SetContentAreaCss(titleTabHeight) {
        var self = this;
        var contentAreaList = this.ControlInfo.ControlView.find(
          '.w-label-content>li[data-area]>.smAreaC[cid="' +
            this.ControlInfo.CtrlId +
            '"]'
        );
        contentAreaList.each(function (a, b) {
          self.SetEleWidthAndHeightByAdjustControlInfo($(b), {
            Width: self.ControlInfo.AdjustControlInfo.Width,
            Height: self.ControlInfo.AdjustControlInfo.Height - titleTabHeight,
          });
        });
        _get(
          tabAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(tabAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
      },
    },
    {
      ...
      value: function GetDisplayHeight() {
        ...
        switch (this.ControlInfo.StyleName) {
          ...
          case "Style7": {
            tabHeight =
              this.ControlInfo.ControlView[0].style.height.replace("px", "") *
              1;
            break;
          }
          case "Style10": {
            tabHeight = this.ControlInfo.ControlView.children()
              .find(">.w-label")
              .height();
            break;
          }
        ...
        switch (StyleName) {
          case "Style10": {
            if (matchMedia750) {
              var $TabContentH =
                63 +
                this.ControlInfo.ControlView.children()
                  .find(">.w-label>.w-label-content>.mobile-label-tips-line")
                  .height();
              var $tabItemLength = this.ControlInfo.ControlView.children().find(
                ">.w-label>.w-label-content>.w-label-content-item>.mobile-label-tips-item "
              ).length;
              var smAreaC = this.ControlInfo.ControlView.children().find(
                ">.w-label>.w-label-content>.w-label-content-item.current>.smAreaC"
              );
              if (smAreaC.length > 0) {
                var b = smAreaC[0];
                var maxHeight = 0;
                ...
                if (maxHeight != 0) {
                  this.SetEleCss($(b), {
                    height: maxHeight + AdjustConfig.MinCtrlYPadding + "px",
                    width: "",
                  });
                  height =
                    maxHeight +
                    AdjustConfig.MinCtrlYPadding +
                    $TabContentH * $tabItemLength +
                    this.ControlInfo.ControlView.children()
                      .find(
                        ">.w-label>.w-label-content>.mobile-label-tips-line"
                      )
                      .height();
                } else {
    ...
    },
    {
      ...
      value: function SetWidthAndHeight(newWidth) {
        ...
        switch (this.ControlInfo.StyleName) {
          ...
          case "Style10": {
            var contentTab10 = this.ControlInfo.ControlView.children()
              .children()
              .children(".w-label-content");
            var contenttabArea = contentTab10
              .children(".w-label-content-item.current")
              .children(".smAreaC");
            var border_width =
              parseInt(contenttabArea.css("border-left-width")) * 2;
            this.ControlInfo.AdjustControlInfo.Width4Children =
          ...
          case "Style11": {
            ...
            var border_width =
              parseInt(contenttabArea.css("border-left-width")) * 2;
            var labelTipsWidth = window.matchMedia("(max-width:750px)").matches
              ? 0
              : this.ControlInfo.ControlView.find(".w-label-tips").width();
            this.ControlInfo.AdjustControlInfo.Width4Children =
              newWidth - labelTipsWidth - border_width;
          ...
          case "Style10": {
            ...
            if (style10Isclose) {
              this.ControlInfo.ControlView.children()
                ...
                .attr("status", "open");
              this.ControlInfo.ControlView.children()
                .find(">.w-label>.w-label-tips>.w-label-tips-item")
                .eq(0)
                .click();
            }
            this.SetEleCss(
              this.ControlInfo.ControlView.children().find(
                ">.w-label>.w-label-content>.w-label-content-item"
              ),
              { height: "auto" }
            );
            this.OriMarginLeft = this.ControlInfo.ControlView.find("ul")
              .eq(0)
              .find("li")
              .eq(0)
              .width();
            var titleLiList = this.ControlInfo.ControlView.find("ul")
              .eq(0)
              .find("[data-area]");
            var totalLength = this.ControlInfo.ControlView.find("ul")
              .eq(0)
              .find("li").length;
            var width = AdjustHelper.ToFixed(
              (this.ControlInfo.AdjustControlInfo.Width -
                this.OriMarginLeft * (totalLength - titleLiList.length)) /
                titleLiList.length
            );
            var tabStyleOffset =
              this.ControlInfo.AdjustControlInfo.Width -
              (width * titleLiList.length +
                this.OriMarginLeft * (totalLength - titleLiList.length));
            titleLiList.each(function (a, b) {
              self.SetEleCss($(b), { width: width + "px" });
            });
            self.SetEleCss(titleLiList.eq(0), {
              width: width + tabStyleOffset + "px",
            });
            _get(
              tabAdjuster.prototype.__proto__ ||
                Object.getPrototypeOf(tabAdjuster.prototype),
            ...
            // 选中样式
            var currItem = this.ControlInfo.ControlView.children().find(
      ...
      value: function SetCtrlCss() {
        ...
        switch (this.ControlInfo.StyleName) {
          case "Style1": {
            ...
            var width = AdjustHelper.ToFixed(
              (this.ControlInfo.AdjustControlInfo.Width -
                (totalLength - titleLiList.length) * this.OriMarginLeft) /
                titleLiList.length
            );
            titleLiList.each(function (a, b) {
              self.SetEleCss($(b), { width: width + "px" });
            ...
            this.SetContentAreaCss(
              this.ControlInfo.ControlView.find("ul")
                .eq(0)
                .find("li")
                .eq(0)
                .height()
          ...
          case "Style2": {
            ...
            var totalLength =
              this.ControlInfo.ControlView.find("ul").eq(0).find("li").length -
              2;
            var marginWidth =
              (totalLength - titleLiList.length) * this.OriMarginLeft + 2;

            var isOverflow =
              titleTotalWidth >
              this.ControlInfo.AdjustControlInfo.Width - marginWidth;
            if (isOverflow) {
              var width = AdjustHelper.ToFixed(
                (this.ControlInfo.AdjustControlInfo.Width - marginWidth) /
                  titleLiList.length
          ...
          case "Style4": {
            var contentAreaList = this.ControlInfo.ControlView.find(
              ".w-label-content>li[data-area]>.smAreaC"
            );

            contentAreaList.each(function (a, b) {
              self.SetEleCss($(b), {
                width:
                  _this67.ControlInfo.AdjustControlInfo.Width4Children + "px",
              });
            });
            _get(
              tabAdjuster.prototype.__proto__ ||
          ...
          case "Style5": {
            var contentAreaList = this.ControlInfo.ControlView.find(
              ".w-label-tips>li[data-area]>.w-label-content"
            );
            ...
            contentAreaList.each(function (a, b) {
              self.SetEleCss($(b), {
                width:
                  self.ControlInfo.AdjustControlInfo.Width -
                  self.ControlInfo.WidthOffset +
                  "px",
                height: self.ControlInfo.AdjustControlInfo.Height + "px",
              });
            });
            _get(
              tabAdjuster.prototype.__proto__ ||
          ...
          case "Style10": {
            ...
            if (window.matchMedia("(max-width:750px)").matches) {
              ...
              self.SetEleCss(
                this.ControlInfo.ControlView.children().find(
                  ">.w-label>.w-label-content>.w-label-content-item>.mobile-label-tips-item a"
                ),
                { width: this.ControlInfo.AdjustControlInfo.Width - 100 + "px" }
              );
              this.SetEleCss(
                this.ControlInfo.ControlView.children().find(
                  ">.w-label>.w-label-content>.w-label-content-item"
              ...
              currItem
                .siblings()
                .removeClass("current")
                .children(".mobile-label-tips-line,.mobile-label-tips-item")
                .removeClass("current");
              currItem
                .children(".mobile-label-tips-line,.mobile-label-tips-item")
                .addClass("current");
          ...
          case "Style11": {
            ...
            if (window.matchMedia("(max-width:750px)").matches) {
              ...
              self.SetEleCss(
                ...
                { width: this.ControlInfo.AdjustControlInfo.Width - 120 + "px" }
              );
              ...
              var style11OriMarginLeft = parseInt(
                this.ControlInfo.ControlView.children()
                  .find(">.w-label >.w-label-tips >.w-label-tips-line")
                  .eq(0)
                  .css("height")
              );
              var totalStyle11Length = this.ControlInfo.ControlView.children()
                .find(">.w-label > .w-label-tips")
                .children().length;
              var style11Height =
                (this.ControlInfo.AdjustControlInfo.Height -
                  style11OriMarginLeft *
                    (totalStyle11Length - titleLiListStyle11.length)) /
                titleLiListStyle11.length;
              titleLiListStyle11.each(function (a, b) {
                self.SetEleCss($(b), { height: style11Height + "px" });
                self.SetEleCss($(b).children(".tabImg"), {
                  "max-height": style11Height + "px",
                });
              });
              this.SetEleCss(
                this.ControlInfo.ControlView.children().find(
    ...
    },
    {
      ...
      value: function SetContentAreaCssForStyle10And11(type) {
        ...
        var forceShowEles = this.ControlInfo.ControlView.find(".forceShow");
        forceShowEles.removeClass("forceShow");
        var contentAreaList = this.ControlInfo.ControlView.children()
          .children()
          .children(".w-label-content")
          .children(".w-label-content-item")
          .children(".smAreaC");
        var contentAreaCurrentList = this.ControlInfo.ControlView.children()
          .children()
          .children(".w-label-content")
          .children(".w-label-content-item.current");
        var tipsAreaCurrentList = this.ControlInfo.ControlView.children()
          .children()
          .children(".w-label-tips")
          .children(".w-label-tips-item.current");
        var contentAreaCurrent = this.ControlInfo.ControlView.children()
          .children()
          .children(".w-label-content")
          .children(".w-label-content-item.current")
          .children(".smAreaC");
        ...
        if (window.matchMedia("(max-width:750px)").matches) {
          if (contentAreaCurrentList.length > 0) {
            if (
              contentAreaCurrentList
                .find(">.mobile-label-tips-item>.tabImg")
                .attr("hoverurl") != "''"
            ) {
              contentAreaCurrentList
                .find(">.mobile-label-tips-item>.tabImg")
          ...
          if (type == 10) {
            ...
            contentAreaCurrentList.each(function (a, b) {
              ...
              if (maxHeight > _this68.OriginalHeight) {
                ...
                _this68.ControlInfo.AdjustControlInfo.Height =
                  maxHeight + AdjustConfig.MinCtrlYPadding;
              } else {
                _this68.SetEleCss($(b), {
                  height: _this68.OriginalHeight + "px",
                });
              }
            });
          }
...
var dialogAdjuster = (function (_baseAdjuster36) {
  ...
  function dialogAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (dialogAdjuster.__proto__ || Object.getPrototypeOf(dialogAdjuster)).call(
        this,
        controlInfo
      )
    );
...
var videoAdjuster = (function (_baseAdjuster37) {
  ...
  function videoAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (videoAdjuster.__proto__ || Object.getPrototypeOf(videoAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(videoAdjuster, [
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        _get(
          videoAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(videoAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
        this.SetEleWidthAndHeightByAdjustControlInfo(
          this.ControlInfo.ControlView.find(".video_Style1")
        );
        this.SetEleWidthAndHeightByAdjustControlInfo(
          this.ControlInfo.ControlView.find(".w-video")
        );
        this.SetEleWidthAndHeightByAdjustControlInfo(
          this.ControlInfo.ControlView.find("iframe")
        );
        this.SetEleCss(this.ControlInfo.ControlView.find(".w-video>div"), {
          "line-height": this.ControlInfo.AdjustControlInfo.Height + "px",
        });
      },
    },
  ]);
...
var alivideoAdjuster = (function (_baseAdjuster38) {
  ...
  function alivideoAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        alivideoAdjuster.__proto__ || Object.getPrototypeOf(alivideoAdjuster)
      ).call(this, controlInfo)
    );
  }
  ...
  _createClass(alivideoAdjuster, [
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        _get(
          alivideoAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(alivideoAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
        this.SetEleWidthAndHeightByAdjustControlInfo(
          this.ControlInfo.ControlView.find(".alivideo_Style1")
        );
        this.SetEleCss(this.ControlInfo.ControlView.find(".defaultTitle"), {
          width: this.ControlInfo.AdjustControlInfo.Width + "px",
        });
      },
    },
...
var bannerAdjuster = (function (_baseAdjuster39) {
  ...
  function bannerAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (bannerAdjuster.__proto__ || Object.getPrototypeOf(bannerAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(bannerAdjuster, [
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        ...
        this.SetEleCss(
          this.ControlInfo.ControlView.find(
            ".fullcolumn-inner[cid=" + this.ControlInfo.CtrlId + "]"
          ),
          {
            height: this.ControlInfo.AdjustControlInfo.Height + "px",
            width: this.ControlInfo.AdjustControlInfo.Width + "px",
        ...
        _get(
          bannerAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(bannerAdjuster.prototype),
          "SetLzparallax",
          this
        ).call(
          this,
          this.ControlInfo.ControlView.find(
            "#bannerWrap_" + this.ControlInfo.CtrlId + " > .w-banner-image"
          )
        );
      },
    },
...
var codeAdjuster = (function (_baseAdjuster40) {
  ...
  function codeAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (codeAdjuster.__proto__ || Object.getPrototypeOf(codeAdjuster)).call(
        this,
        controlInfo
      )
    );
      ...
      value: function SetWidthAndHeight(newWidth) {
        ...
        switch (zoomMode) {
          case "SetWidthAndHeight_JustWidth": {
            _get(
              codeAdjuster.prototype.__proto__ ||
                Object.getPrototypeOf(codeAdjuster.prototype),
              "SetWidthAndHeight_JustWidth",
              this
            ).call(this, newWidth);
            break;
...
var mustacheAdjuster = (function (_baseAdjuster41) {
  ...
  function mustacheAdjuster(controlInfo) {
    ...
    var _this74 = _possibleConstructorReturn(
      this,
      (
        mustacheAdjuster.__proto__ || Object.getPrototypeOf(mustacheAdjuster)
      ).call(this, controlInfo)
    );
    ...
    var self = _this74;
    _this74.ControlInfo.ControlView.find(".w-resulte-btn-more").on(
      "click",
      function (e) {
        if (self.HeightOffset === null) {
          self.HeightOffset =
            self.ControlInfo.ControlView.height() - self.ControlInfo.Height;
        }

        self.IsOpen = self.ClickCounter++ % 2 === 0;

        if (
          CtrlAdjuster.GetCurrentBrowserWidth() > CtrlAdjuster.GetOriPageWidth()
        ) {
          window.xa.Adjuster.AddOriMainHeight(
            self.HeightOffset * (self.IsOpen ? 1 : -1)
          );
        }
        //else {
        //    if (self.IsOpen) {
  ...
  _createClass(mustacheAdjuster, [
    {
      ...
      value: function SetWidthAndHeight(newWidth) {
        this.ControlInfo.AdjustControlInfo.Width = newWidth;
        this.ControlInfo.AdjustControlInfo.Height = this.IsOpen
          ? this.ControlInfo.ControlView.height()
          : this.ControlInfo.Height;
      },
    },
  ]);
...
var qrcodeAdjuster = (function (_fixMinZoomAs1Adjuste10) {
  ...
  function qrcodeAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (qrcodeAdjuster.__proto__ || Object.getPrototypeOf(qrcodeAdjuster)).call(
        this,
        controlInfo
      )
    );
  ...
  _createClass(qrcodeAdjuster, [
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        this.SetEleWidthAndHeightByAdjustControlInfo(
          this.ControlInfo.ControlView.find(
            ".qrcode_Style1,.qrcode_Style1,.w-qrcode,img"
          )
        );

        _get(
          qrcodeAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(qrcodeAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
      },
    },
    {
      ...
      value: function ChangedRowAct(cell, headerCtrl, header) {
        _get(
          qrcodeAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(qrcodeAdjuster.prototype),
          "ChangedRowAct_AlignLeft",
          this
        ).call(this, cell, headerCtrl, header);
      },
    },
  ]);
...
var newsItemCreatedDatetimeBindAdjuster = (function (_fixMinZoomAs1Adjuste11) {
  ...
  function newsItemCreatedDatetimeBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        newsItemCreatedDatetimeBindAdjuster.__proto__ ||
        Object.getPrototypeOf(newsItemCreatedDatetimeBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var newsItemFavoritesBindAdjuster = (function (_fixMinZoomAs1Adjuste12) {
  ...
  function newsItemFavoritesBindAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        newsItemFavoritesBindAdjuster.__proto__ ||
        Object.getPrototypeOf(newsItemFavoritesBindAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var formpanelAdjuster = (function (_baseAdjuster42) {
  ...
  function formpanelAdjuster(controlInfo) {
    ...
    var _this78 = _possibleConstructorReturn(
      this,
      (
        formpanelAdjuster.__proto__ || Object.getPrototypeOf(formpanelAdjuster)
      ).call(this, controlInfo)
    );
  ...
  _createClass(formpanelAdjuster, [
    {
      ...
      value: function SetWidthAndHeight(newWidth) {
        this.ControlInfo.AdjustControlInfo.Width = newWidth;
        _get(
          formpanelAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(formpanelAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        ...
        var padding =
          AdjustHelper.GetCssPixelSize(
            this.ControlInfo.ControlView.find(".w-submit-outer"),
            "padding-left"
          ) * 2;
        var btnWidth =
          this.OriBtnWidth > this.ControlInfo.AdjustControlInfo.Width
            ? this.ControlInfo.AdjustControlInfo.Width
            : this.OriBtnWidth;

        this.SetEleCss(this.ControlInfo.ControlView.find(".w-submit"), {
          "min-width": btnWidth - padding + "px",
        });
      },
    },
  ]);
...
var fullpageSlideAdjuster = (function (_slidesetAdjuster) {
  ...
  function fullpageSlideAdjuster(controlInfo) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        fullpageSlideAdjuster.__proto__ ||
        Object.getPrototypeOf(fullpageSlideAdjuster)
      ).call(this, controlInfo)
    );
  }
...
var multinavAdjuster = (function (_baseAdjuster43) {
  ...
  function multinavAdjuster(controlInfo) {
    ...
    var _this80 = _possibleConstructorReturn(
      this,
      (
        multinavAdjuster.__proto__ || Object.getPrototypeOf(multinavAdjuster)
      ).call(this, controlInfo)
    );

    _this80.LogoPercent = AdjustHelper.ToFixed(
      (_this80.ControlInfo.ControlView.find(".logo-area").attr("data-width") *
        1) /
        100,
      3
    );
    _this80.NavPercent = AdjustHelper.ToFixed(
      (_this80.ControlInfo.ControlView.find(".nav-area").attr("data-width") *
        1) /
        100,
      3
    );
  ...
  _createClass(multinavAdjuster, [
    ...
    },
    {
      ...
      value: function SetCtrlCss() {
        ...
        if (
          CtrlAdjuster.GetCurrentBrowserWidth() <= 750 ||
          CtrlAdjuster.IsMobile
        ) {
          this.SetEleCss(this.ControlInfo.ControlView.find(".logo-area"), {
            display: "none",
          ...
          this.SetEleCss(
            this.ControlInfo.ControlView.find(".nav_mobile_wrapper"),
            {
              display: "flex",
            }
          );
          this.ControlInfo.ControlView.find(".nav-container").addClass(
            "navMobile-container"
          );
          if (
            this.ControlInfo.ControlView.find(".areaWrapper > div").length == 0
          ) {
            this.ControlInfo.ControlView.find(".nav_Area > div").appendTo(
              this.ControlInfo.ControlView.find(".areaWrapper")
            );
          }
          var slef = this;
          this.ControlInfo.ControlView.find(".areaWrapper > div").each(
            function (index, item) {
              slef.SetEleCss($(item), {
                position: "relative",
                left: "0",
                ...
                zIndex:
                  "" +
                  (slef.ControlInfo.ControlView.find(".areaWrapper > div")
                    .length -
                    index),
                width: "240px",
                marginTop: "30px",
          ...
          if (
            ...
            this.ControlInfo.ControlView.find(".areaWrapper > div").appendTo(
              this.ControlInfo.ControlView.find(".nav_Area")
            );
            this.ControlInfo.ControlView.find(".nav_Area > div").each(function (
              index,
              item
            ) {
          ...
          this.ControlInfo.ControlView.find(".nav-container").removeClass(
            "navMobile-container"
          );
          this.SetEleCss(
            this.ControlInfo.ControlView.find(".nav_mobile_wrapper"),
          ...
          var areaWidth = AdjustHelper.ToFixed(
            CtrlAdjuster.GetCurrentBrowserWidth() * this.NavPercent
          );
          this.SetEleCss(this.ControlInfo.ControlView.find(".logo-area"), {
            width:
              AdjustHelper.ToFixed(
                CtrlAdjuster.GetCurrentBrowserWidth() * this.LogoPercent
              ) + "px",
            display: "block",
          });
          this.SetEleCss(this.ControlInfo.ControlView.find(".nav-area"), {
          ...
          if (
            ...
            if (!this.IsFullScreen) {
              ...
              this.SetEleCss(
                this.ControlInfo.ControlView.find(".nav-content"),
                {
                  width: CtrlAdjuster.OriPageWidth + "px",
                }
              );
              this.SetEleCss(
                this.ControlInfo.ControlView.find(".nav-container"),
                {
                  width: CtrlAdjuster.OriPageWidth + "px",
                  left:
                    (CtrlAdjuster.GetCurrentBrowserWidth() -
              ...
              var areaWidth = AdjustHelper.ToFixed(
                CtrlAdjuster.OriPageWidth * this.NavPercent
              );
              this.SetEleCss(this.ControlInfo.ControlView.find(".logo-area"), {
                width:
                  AdjustHelper.ToFixed(
                    CtrlAdjuster.OriPageWidth * this.LogoPercent
                  ) + "px",
                display: "block",
              });
              this.SetEleCss(this.ControlInfo.ControlView.find(".nav-area"), {
          ...
          var currentItemWidth = AdjustHelper.ToFixed(
            this.ControlInfo.ControlView.find(".nav-area").width() /
              items.length,
            0
          );
          items.each(function (a, b) {
            _this81.SetEleCss($(b), {
              width:
                (currentItemWidth < _this81.OriItemWidth
                  ? currentItemWidth
                  : _this81.OriItemWidth) + "px",
            });
          });
...
var flexiblePanelAdjuster = (function (_baseAdjuster44) {
  ...
  function flexiblePanelAdjuster(controlInfo) {
    ...
    var _this82 = _possibleConstructorReturn(
      this,
      (
        flexiblePanelAdjuster.__proto__ ||
        Object.getPrototypeOf(flexiblePanelAdjuster)
      ).call(this, controlInfo)
    );
    ...
    switch (_this82.ControlInfo.StyleName) {
      case "Style1": {
        ...
        _this82.LeftBorder = AdjustHelper.GetCssPixelSize(
          controlInfo.ControlView.find(".w-label-content"),
          "border-left-width"
        );
        _this82.RightBorder = AdjustHelper.GetCssPixelSize(
          controlInfo.ControlView.find(".w-label-content"),
          "border-right-width"
        );
        break;
  ...
  _createClass(flexiblePanelAdjuster, [
    {
      ...
      value: function GetDisplayHeight() {
        ...
        switch (this.ControlInfo.StyleName) {
          ...
          default: {
            tabHeight = _get(
              flexiblePanelAdjuster.prototype.__proto__ ||
                Object.getPrototypeOf(flexiblePanelAdjuster.prototype),
              "GetDisplayHeight",
              this
            ).call(this);
          }
    ...
    },
    {
      ...
      value: function SetContentAreaCss() {
        ...
        var contentAreaList = this.ControlInfo.ControlView.children()
          .children()
          .children(".w-label-item")
          .find(">.w-label-content>.smAreaC");
        contentAreaList.each(function (a, b) {
          var maxHeight = 0;
          $(b).parent().show();
          var bTop = b.getBoundingClientRect().top;
      ...
      value: function _ClearControlEffect() {
        ...
        if (ControlView.data("smart.remcopute")) {
          ControlView.children()
            .children()
            .children('[data-area="' + selectarea + '"]')
            .children(".w-label-title")
            .click();
        }
      },
    },
      ...
      value: function _ResizeControlEffect() {
        ...
        if (Promise) {
          Promise.resolve().then(function () {
            ...
            if (selectarea) {
              _this84.ControlInfo.ControlView.children()
                .children()
                .children('[data-area="' + selectarea + '"]')
                .children(".w-label-title")
                .click();
...
var breadcrumbAdjuster = (function (_baseAdjuster45) {
  ...
  function breadcrumbAdjuster() {
    ...
    return _possibleConstructorReturn(
      this,
      (
        breadcrumbAdjuster.__proto__ ||
        Object.getPrototypeOf(breadcrumbAdjuster)
  ...
  _createClass(breadcrumbAdjuster, [
    ...
    },
    {
      ...
      value: function SetWidthAndHeight(newWidth) {
        this.ControlInfo.AdjustControlInfo.Width = newWidth;
        _get(
          breadcrumbAdjuster.prototype.__proto__ ||
            Object.getPrototypeOf(breadcrumbAdjuster.prototype),
          "SetCtrlCss",
          this
        ).call(this);
  ...
  _createClass(AdjustControlInfo, [
    {
      ...
      value: function InitLineNum() {
        if (this.ControlInfo.IsFirstCell) {
          ...
          var isOverflowOfLine =
            overflowStartIndex !== null
              ? this.ControlInfo.IndexOfRow >= overflowStartIndex
              : false;
          if (isOverflowOfLine) {
            var lastLineNum = Math.max.apply(
              Math,
              this.ControlInfo.PrevCtrls.map(function (o) {
                return o.AdjustControlInfo.LineNum;
              })
            );
            var createNewLine =
              this.ControlInfo.RowInfo.Cells.filter(function (i) {
    ...
    },
    {
      ...
      value: function SkipAddParentHeight() {
        if (
          this.ControlInfo.MightBeBackground ||
          this.ControlInfo.SkipFormatRowOffset ||
          (this.Parent && this.Parent.IsMultiContainer)
        ) {
          return true;
        }
        return false;
    ...
    },
    {
      ...
      get: function get() {
        ...
        var nextLine = this.ControlInfo.RowInfo.Cells.find(function (i) {
          return (
            i.AdjustControlInfo.IndexOfLine === _this87.IndexOfLine &&
            i.AdjustControlInfo.LineNum === _this87.LineNum + 1
          );
        });
        return nextLine;
      },
    },
    {
      ...
      get: function get() {
        ...
        var prevLine = this.ControlInfo.RowInfo.Cells.find(function (i) {
          return (
            i.AdjustControlInfo.IndexOfLine === _this88.IndexOfLine &&
            i.AdjustControlInfo.LineNum === _this88.LineNum - 1
          );
        });
        return prevLine;
      },
    ...
    },
    {
      ...
      get: function get() {
        ...
        return (
          this.ControlInfo.RowInfo.Cells.find(function (i) {
    ...
    },
    {
      ...
      get: function get() {
        return this._width4Children === null
          ? this.Width
          : this._width4Children > this.ParentWidthSubPadding
          ? this.ParentWidthSubPadding
          : this._width4Children;
      },
    },
    {
      key: "ParentWidth",
      get: function get() {
        return this.Parent
          ? this.Parent.AdjustControlInfo.Width4Children
          : CtrlAdjuster.GetCurrentBrowserWidth();
      },
    },
    {
    ...
    },
    {
      key: "Left",
      get: function get() {
        return this._left <= this.ControlInfo.ParentXPadding
          ? this.ControlInfo.ParentXPadding
          : this._left;
      },
    ...
    },
    {
      ...
      get: function get() {
        if (this.ForceGetWidth) {
          ...
          return this._width > this.ParentWidthSubPadding
            ? this.ParentWidthSubPadding
            : this._width;
        }
      },
  ...
  _createClass(ControlInfo, [
    {
      ...
      value: function ResetAdjustControlInfo() {
        this.AdjustControlInfo = new AdjustControlInfo(
          this,
          this.DisplayWidth,
          this.Height,
          this.Left,
    ...
    },
    {
      ...
      value: function IsChildNodeOfSpecCtrlName(parentCtrlName, styleName) {
        if (this.Parent) {
          if (
            this.Parent.CtrlName === parentCtrlName &&
            (!styleName || this.Parent.StyleName === styleName)
          ) {
            return true;
          } else {
            return this.Parent.IsChildNodeOfSpecCtrlName(
              parentCtrlName,
              styleName
            );
          }
      ...
      get: function get() {
        if (this._mightBeBackground === null) {
          return (this._mightBeBackground =
            this.CtrlName === "dialog" || this.IsFixedCtrl);
        } else {
          return this._mightBeBackground;
        }
      },
        ...
        if (this._isMultiContainer === null) {
          if (this.CtrlName === "area" && this.StyleName === "Style3") {
            ...
            return (this._isMultiContainer =
              containerList.indexOf(this.CtrlName) !== -1);
          }
        } else {
          return this._isMultiContainer;
        }
    ...
    },
    {
      ...
      get: function get() {
        if (
          (this.Parent &&
            this.Parent.CtrlName === "tab" &&
            this.Parent.StyleName === "Style6") ||
          (this.Parent &&
            this.Parent.CtrlName === "tab" &&
            this.Parent.StyleName === "Style2") ||
    ...
    },
    {
      ...
      get: function get() {
        ...
        return this.RowInfo.FirstCell.Left < AdjustConfig.MinCtrlXPadding ||
          this.ParentWidth - this.RowInfo.LastCell.Right <
            AdjustConfig.MinCtrlXPadding
          ? 0
          : AdjustConfig.MinCtrlXPadding;
      },
    },
    {
      ...
      get: function get() {
        ...
        return this.Parent
          ? AdjustConfig.MinCtrlYPadding
          : AdjustConfig.MinDocumentYPadding;
      },
    },
    {
    ...
    },
    {
      key: "IsFixedCtrl",
      get: function get() {
        return this._isFixedCtrl === null
          ? (this._isFixedCtrl =
              this.ControlView &&
              this.ControlView.hasClass(AdjustConfig.FixedCtrlFlag))
          : this._isFixedCtrl;
      },
      //响应式跳过
    },
    {
      ...
      get: function get() {
        ...
        //跳过小尺寸的代码控件
          ...
          this.CtrlName === "code" &&
          this.ControlView.find(".w-code>div").find(":not(style,script,link)")
            .length === 0
        ) {
    ...
    },
    {
      ...
      get: function get() {
        if (this._topOffsetOfRow === null) {
          return this.PrevRow
            ? this.PrevRow.NewBottom -
                this.PrevRow.Bottom +
                this.PrevRow.TopOffsetOfRow
            : 0;
        } else {
    ...
    },
    {
      ...
      get: function get() {
        return this._bottom === null
          ? (this._bottom = Math.max.apply(
              Math,
              this.Cells.map(function (o) {
                return o.Bottom;
              })
            ))
          : this._bottom;
...
var PreloadItem = (function () {
  ...
  _createClass(PreloadItem, [
    ...
    },
    {
      ...
      get: function get() {
        return this.IndexOfRow > 0
          ? this._preloadInfoRow.Items[this.IndexOfRow - 1]
          : null;
      },
    },
    {
      key: "NextItem",
      get: function get() {
        return this.IndexOfRow >= this._preloadInfoRow.Items.length
          ? null
          : this._preloadInfoRow.Items[this.IndexOfRow + 1];
      },
    },
    ...
    },
    {
      ...
      get: function get() {
        return this.ZoomMode === 0
          ? this._zoomedLeftGap - this.LeftGapOffset
          : this.MinZoomedLeftGap;
      },
    },
    {
      key: "ZoomLeft",
      ...
      get: function get() {
        if (this._zoomLeft === null) {
          return AdjustHelper.ToFixed(
            this.PrevItem === null
              ? this.ZoomedLeftGap
              : this.PrevItem.ZoomRight + this.ZoomedLeftGap
          );
        } else {
    ...
    },
    {
      ...
      get: function get() {
        return this.Cell.LeftGap < AdjustConfig.MinCtrlXPadding
          ? this.Cell.LeftGap
          : AdjustConfig.MinCtrlXPadding;
      },
    },
    ...
    },
    {
      ...
      value: function AdjustSubWidthOffset(rowId) {
        for (var x = 0; x < this.Items.length; x++) {
          ...
          if (
            item.Cell.LeftGap >= AdjustConfig.MinCtrlXPadding &&
            width2Sub > 0
          ) {
            for (var y = 0; y < this.Items.length; y++) {
              if (y !== x) {
                ...
                if (anotherItem.ZoomedLeftGap > AdjustConfig.MinCtrlXPadding) {
                  var subVal =
                    anotherItem.ZoomedLeftGap - AdjustConfig.MinCtrlXPadding;
                  if (subVal > width2Sub) {
    ...
    [
      {
        ...
        value: function InitOriFixedWidthEleList() {
          ...
          for (var i = 0; i < eles.length; i++) {
            var ele = eles.eq(i);
            if (
              (ele[0].style["width"] === CtrlAdjuster.OriPageWidth + "px" ||
                ele[0].style["min-width"] ===
                  CtrlAdjuster.OriPageWidth + "px") &&
              !ele.attr("ctype") &&
              ele[0].nodeType === 1
            ) {
      ...
      },
      {
        ...
        value: function InitTable() {
          ...
          self.CtrlTable.forEach(function (row) {
            //修正top偏移量,防止某些top不对齐
            var average =
              row.Cells.reduce(function (total, next) {
                return total + next.Top;
              }, 0) / row.Cells.length;
            if (
              !row.Cells.some(function (n) {
            ...
            row.Cells.forEach(function (cell) {
              ...
              cell.CtrlAdjuster.CalculateMultiContainerHeight &&
                cell.CtrlAdjuster.CalculateMultiContainerHeight();
            });
          });
      ...
      },
      {
        ...
        value: function ResetPage2OriCss() {
          ...
          CtrlAdjuster.MainEle.height(
            this.OriMainHeight + this.OriMainHeightOffset
          );
      ...
      },
      {
        ...
        value: function SetIcpWidth() {
          ...
          if (icp) {
            icp
              .find(".bottom-content")
              .width(CtrlAdjuster.GetCurrentBrowserWidth());
          }
        },
      },
      {
      ...
      },
      {
        ...
        value: function SetPageHeight() {
          function GetBottom(ctrl) {
            ...
            var bottom =
              ctrl.AdjustControlInfo.TopWithOffset +
              ctrl.AdjustControlInfo.Height;
          ...
          var headerAreaBottom =
            Math.max.apply(
              Math,
              this.CtrlList.filter(function (x) {
          ...
          //没有控件时会为-Infinity
          headerAreaBottom =
            Math.abs(headerAreaBottom) === Infinity
              ? CtrlAdjuster.HeaderEle.height()
              : headerAreaBottom;
          mainAreaBottom =
            Math.abs(mainAreaBottom) === Infinity
              ? CtrlAdjuster.MainEle.height()
              : mainAreaBottom;
          footerAreaBottom =
            Math.abs(footerAreaBottom) === Infinity
              ? CtrlAdjuster.FooterEle.height()
              : footerAreaBottom;
          var oriMaxBottom = Math.max.apply(
            Math,
            this.CtrlList.filter(function (x) {
              return x.CtrlLocation === "main" && !x.SkipHeightCalc;
            }).map(function (i) {
          ...
          var mainAreaHeight =
            mainAreaBottom + (bottomPadding > 0 ? bottomPadding : 0);
          CtrlAdjuster.HeaderEle.height(
            headerAreaBottom <= AdjustConfig.AutoNavHeight
              ? AdjustConfig.AutoNavHeight
              : headerAreaBottom
          );
      ...
      },
      {
        ...
        value: function GetHeightOfTab(tabId) {
          ...
          var areaId = tab.ControlView.find(
            "li.w-label-tips-item.current"
          ).attr("data-area");
          var ctrls = CtrlAdjuster.StaticCtrlList.filter(function (x) {
            return (
              x.ParentId === tabId && !x.SkipHeightCalc && x.AreaId === areaId
            );
          });
          var maxBottom = Math.max.apply(
            Math,
      ...
      },
      {
        ...
        value: function LaunchAdjuster(opt) {
          ...
          function Engage() {
            ...
            if (
              isFirstTime &&
              currentBrowserWidth >= CtrlAdjuster.OriPageWidth
            ) {
              return;
            }
            self.ResetLayout();
            ...
            baseAdjuster.ShowHiddenCtrls(function (scope) {
              ...
              levelList.forEach(function (level) {
                ...
                rows.forEach(function (row) {
                  row.PreLoadRowAdjustControlInfo =
                    scope.PreLoadRowAdjustControlInfo(row);
              ...
              function AdjustMultiContainerHeight() {
                ...
                containerList.forEach(function (container) {
                  switch (container.CtrlName) {
                    ...
                    case "slideset":
                    case "fullpageSlide": {
                      container.AdjustControlInfo.Height +=
                        scope.GetHeightOfMultiContainer(container.CtrlId);
                      break;
                    }
                    case "area": {
                ...
                rows.forEach(function (row) {
                  ...
                  lines.forEach(function (lineNum) {
                    var line = row.Cells.filter(function (i) {
                      return (
                        i.AdjustControlInfo.LineNum == lineNum && i.IsContainer
                      );
                    });
                    if (line.length > 1) {
      ...
      },
      {
        ...
        value: function GetZoomValue(ctrl) {
          var minZoom =
            ctrl.AdjustControlInfo.ParentWidthSubPadding / ctrl.ParentWidth;
          ...
          return {
            ZoomVal: zoomVal,
            MinZoom: AdjustHelper.ToFixed(minZoom, 3),
          };
        },
      },
      {
        ...
        value: function PreLoadRowAdjustControlInfo(row) {
          ...
          var parentWidthSubPadding =
            firstCell.AdjustControlInfo.ParentWidthSubPadding;
          ...
          if (zoomVal > 1) {
            ...
            //1:控件宽度不能继续缩小了,缩放控件
            var zoomMode =
              parentWidthSubPadding - totalMinGap >= cellsOriTotalWidth ? 0 : 1;
            //当zoomModel等于1时才需要用的上zoomVal
            zoomVal =
              (parentWidthSubPadding - totalMinGap) / cellsOriTotalWidth;

            //该行需要减去的差值
            var rowWidthSubVal =
              oriParentWidth -
              parentWidthSubPadding -
              (oriParentWidth - row.LastCell.DisplayRight);

            row.Cells.forEach(function (cell) {
              var minZoom =
                zoomVal <= cell.CtrlAdjuster.MinZoom
                  ? cell.CtrlAdjuster.MinZoom
                  : zoomVal;
              var zoomedLeftGap;
              //不可与下面混写,因为为负数时越乘越小
              if (cell.LeftGap < 0) {
                ...
                if (cell.LeftGap < AdjustConfig.MinCtrlXPadding) {
                  ...
                  if (rowWidthSubVal > 0) {
                    ...
                    zoomedLeftGap =
                      totalNeedZoomGap === 0
                        ? 0
                        : cell.LeftGap - percent * rowWidthSubVal;
                  } else {
                    zoomedLeftGap = cell.LeftGap;
                  }
                }
      ...
      },
      {
        ...
        value: function GetLayoutTableInfo(row) {
          ...
          if (changeRowStartIndex === null) {
            ...
            return {
              RowCount: Math.ceil(row.Cells.length / changeRowStartIndex),
              ColumnCount: changeRowStartIndex,
            };
          }
        },
      },
      {
        ...
        value: function GetNewTableRowLength(
          overflowCtrlLength,
          totalColumnCount,
          firstRowColumnLength,
          counter
        ) {
          counter = counter || 1;
          if (overflowCtrlLength <= 0) {
            ...
            firstRowColumnLength =
              firstRowColumnLength || totalColumnCount - overflowCtrlLength;
            if (overflowCtrlLength > firstRowColumnLength) {
              return this.GetNewTableRowLength(
                overflowCtrlLength - firstRowColumnLength,
                totalColumnCount,
                firstRowColumnLength,
                ++counter
              );
      ...
      },
      {
        ...
        value: function GetFirstRow(location) {
          var rows =
            CtrlAdjuster.HeaderEle.length !== 0
      ...
      },
      {
        ...
        value: function ToggleHeader() {
          ...
          if (headerRow) {
            changeRow =
              (headerRow.Cells.length === 1 &&
                headerRow.NewHeight > headerRow.Height) ||
              headerRow.Cells.find(function (i) {
          ...
          var isHeaderFixed =
            headerRow.Cells.length === 1 &&
            ((headerRow.Cells[0].StyleName === "Style2" &&
              headerRow.Cells[0].CtrlName === "banner") ||
              (headerRow.Cells[0].IsContainer &&
                headerRow.Cells[0].ControlView &&
                headerRow.Cells[0].ControlView.css("position") === "fixed"));
          if (
            (changeRow ||
              CtrlAdjuster.GetCurrentBrowserWidth() <
                AdjustConfig.SmallScreenWidth ||
            ...
            var FixMainPageHeader = function FixMainPageHeader() {
              ...
              if (
                mainPageHeader &&
                (mainPageHeader.Top < 0 ||
                  mainPageHeader.Top <= AdjustConfig.IntersectOffset)
              ) {
            ...
            var LoadImage = function LoadImage() {
              ...
              if (firstImg) {
                ...
                firstImg.ControlView.find("a").attr(
                  "auto-ctrl-index",
                  indexFlag
                );
              ...
              allCtrl
                ...
                .forEach(function (ctrl) {
                  ...
                  if (isChildNodeOfTab) {
                    ...
                    parentTabId =
                      "parentTabId='" + parent.CtrlId + "_" + areaId + "'";
                  }
                  switch (ctrl.CtrlName) {
                    case "nav": {
                      var topUlClass =
                        ctrl.StyleName === "Style12"
                          ? ".w-nav-item"
                          : ".w-nav-inner";
                      var firstClass =
                        ctrl.StyleName === "Style12" ? "a" : ".w-nav-item-link";
                      var secondLiClass =
                        ctrl.StyleName === "Style12" ? "li" : ".w-subnav-item";
                      var secondClass =
                        ctrl.StyleName === "Style12" ? "a" : ".w-subnav-link";

                      var _baseAdjuster$GetNavC7 = baseAdjuster.GetNavColor(
                          ctrl.ControlView.find(firstClass),
                          ctrl.ControlView.find(".w-nav")
                        ),
                        ForegroundColor =
                          _baseAdjuster$GetNavC7.ForegroundColor,
                        BackgroundColor =
                          _baseAdjuster$GetNavC7.BackgroundColor;

                      backgroundColor = hasSetBgColor
                        ? backgroundColor
                        : BackgroundColor;
                      foregroundColor = ForegroundColor;
                      ...
                      ctrl.ControlView.find(topUlClass).each(function (a, b) {
                        ...
                        if (ctrl.StyleName === "Style12") {
                          backgroundColor = hasSetBgColor
                            ? backgroundColor
                            : AdjustHelper.GetBackGroundColor(navItemLink);
                        }
                        navItemLink.attr("auto-ctrl-index", ++indexFlag);
                        templateStr +=
                          '<li class="auto-nav-li" ' +
                          parentTabId +
                          '><span auto-nav-index="' +
                          indexFlag +
                          '">' +
                        ...
                        if (subNav.length > 0) {
                          ...
                          subNav.find(secondLiClass).each(function (x, y) {
                            ...
                            templateStr +=
                              '<li class="auto-nav-li-child"><span auto-nav-index="' +
                              indexFlag +
                              '">' +
                              navItem.html() +
                              "<span></li>";
                    ...
                    case "navcontainer": {
                      ...
                      ctrl.ControlView.find(".nav-item").each(function (a, b) {
                        ...
                        if (subNav.length > 0) {
                          ...
                          subNav.find(".subnav-item").each(function (x, y) {
                            ...
                            navItem.attr("auto-ctrl-index", ++indexFlag);
                            templateStr +=
                              '<li class="auto-nav-li-child" auto-nav-index="' +
                              indexFlag +
                              '">' +
                              navItem.html() +
                              "</li>";
                      ...
                      var _baseAdjuster$GetNavC8 = baseAdjuster.GetNavColor(
                          ctrl.ControlView.find(".nav-text"),
                          ctrl.ControlView.find(".nav-container")
                        ),
                        ForegroundColor =
                          _baseAdjuster$GetNavC8.ForegroundColor,
                        BackgroundColor =
                          _baseAdjuster$GetNavC8.BackgroundColor;
                    ...
                    case "tab": {
                      var itemList = ctrl.ControlView.find(
                        ".w-label-content-item"
                      );
                      ctrl.ControlView.find(
                        ".w-label-tips-item>.f-ellipsis"
                      ).each(function (x, b) {
                        var text = $(b).html();
                        text = text ? text : " ";
                        var titleTagParent = $(b.parentElement);
                        var bgimg = titleTagParent.css("background-image");
                        var bgUrlMatch = bgimg.match(
                          /url\(["']?([^"']*)["']?\)/
                        );
                        var bgUrl = bgUrlMatch ? bgUrlMatch[1] : "";
                        var imgStr = bgUrl
                          ? "<img src='" + bgUrl + "' width=25 height=25 />"
                          : "";
                        var clickEvent =
                        ...
                        templateStr +=
                          ...
                          ctrl.CtrlId +
                          "_" +
                          itemList.eq(x).attr("data-area") +
                          "' style='margin: 0 0 0 0;'></ul></li>";
                      });
                    ...
                    default: {
                      if (isChildNodeOfTab) {
                        ...
                        if (!ctrl.IsContainer) {
                          templateStr +=
                            '<li class="auto-nav-li" nav-holder="' +
                            ctrl.CtrlId +
                            '" style="height:' +
                            (ctrl.Height + 10) +
                            'px;"></li>';
            ...
            var LoadNav2Body = function LoadNav2Body() {
              headerEle.append(
                '<div style="display:none;" class="hideNav">' +
                  templateStr +
                  "</div>"
              );
              ...
              headerEle.prepend(
                '<div style="width:' +
                  CtrlAdjuster.GetCurrentBrowserWidth() +
                  "px;z-index:99999999;height:" +
                  AdjustConfig.AutoNavHeight +
                  "px;" +
                  (isHeaderFixed ? "position: fixed;" : "") +
                  '" class="headerNavBox"></div>'
              );
              $(".hideNav").slicknav({
                label: "",
              ...
              smallNav.find("[nav-holder]").each(function (a, b) {
                ...
                AdjustHelper.ReplaceEle(
                  $(".liHolder_" + ctrlId),
                  ctrlInfo.ControlView
                );
                //忽略父级最大宽度
                ctrlInfo.AdjustControlInfo.ForceGetWidth = true;
                var isImage =
                  ctrlInfo.CtrlName === "image" ||
                  ctrlInfo.CtrlName === "logoimage" ||
                  ctrlInfo.CtrlName === "qrcode";
                ctrlInfo.AdjustControlInfo.Left =
                  ctrlInfo.AdjustControlInfo.Top = 0;
                ctrlInfo.CtrlAdjuster.SetWidthAndHeight(
                  isImage
                    ? ctrlInfo.Width < maxWidth
                      ? ctrlInfo.Width
                      : maxWidth
                    : maxWidth
                );
                ctrlInfo.CtrlAdjuster.SetEleCss(ctrlInfo.ControlView, {
                  position: "inherit",
                });
              });
              if (logoImg.Src !== null) {
                ...
                if (CtrlAdjuster.LogoImgTop === null) {
                  smallNav.prepend(
                    '<img class="auto-nav-img" onload=\'CtrlAdjuster.SetLogoImgLayout()\' auto-nav-index="' +
                      logoImg.IndexFlag +
                      '" style="position: absolute;max-height:' +
                      (AdjustConfig.AutoNavHeight - 10) +
                      'px;max-width:200px;position: absolute;" src="' +
                      logoImg.Src +
                      '" >'
                  );
                } else {
                  smallNav.prepend(
                    '<img class="auto-nav-img"   auto-nav-index="' +
                      logoImg.IndexFlag +
                      '" style="top:' +
                      CtrlAdjuster.LogoImgTop +
                      "px;position: absolute;max-height:" +
                      (AdjustConfig.AutoNavHeight - 10) +
                      'px;max-width:200px;position: absolute;" src="' +
                      logoImg.Src +
                      '" >'
              ...
              $("[auto-nav-index]").each(function (a, b) {
                ...
                item.click(function (e) {
                  ...
                  if (
                    ...
                    smallNav
                      .find('[tabindex="0"].slicknav_btn.slicknav_open')
                      .click();
                  }
                  //避免又点击又展开菜单,
              ...
              oriNavCtrlIdList.forEach(function (ctrlId) {
                ...
                if (!ctrl.IsVirtualCtrl) {
                  ...
                  if (ctrl.IsChildNodeOfSpecCtrlName("tab")) {
                    ctrl.CtrlAdjuster.SetEleCss(
                      ctrl.ControlView.find(".w-container"),
                      { position: "static" }
                    );
                  }
                  //否则向上隐藏
                  else {
                    ctrl.CtrlAdjuster.SetEleCss(ctrl.ControlView, {
                      top: "-999px",
                    });
                  }
                }
            ...
            if (headerRow.NextRow) {
              headerRow.NextRow.TopOffsetOfRow = -(
                headerRow.NextRow.Top - AdjustConfig.AutoNavHeight
              );
            }
            ...
            var backgroundColor =
              CtrlAdjuster.HeaderEle.length === 0
                ? "transparent"
                : AdjustHelper.GetBackGroundColor(
                    CtrlAdjuster.HeaderEle.parent()
                  );
    ...
    [
                ...
                get: function get() {
                  if (
                    ...
                    document.documentElement.offsetWidth <=
                      AdjustConfig.MockMobileWidthThreshold &&
                    document.documentElement.offsetWidth >
                      AdjustConfig.MockMobileWidth
                  ) {
      ...
      },
      {
        ...
        value: function IsInSameArea(ctrlA, ctrlB) {
          return (
            ctrlA.CtrlLocation == ctrlB.CtrlLocation &&
            ((ctrlA.ParentId == null && ctrlB.ParentId == null) ||
              (ctrlA.ParentId == ctrlB.ParentId &&
                ctrlA.AreaId == ctrlB.AreaId))
          );
        },
      },
      {
        ...
        value: function InitRow(ctrlList2Load) {
          ...
          while (ctrl != null) {
            var row = table.find(function (x) {
              return x.Cells.some(function (i) {
                return (
                  ...
                  ((i.ParentId == null && ctrl.ParentId == null) ||
                    (i.ParentId == ctrl.ParentId && i.AreaId == ctrl.AreaId)) &&
            ...
            if (
              row == null ||
              ctrl.MightBeBackground ||
              ctrl.IsFullRowCtrl ||
              ctrl.CtrlAdjuster.IsVerticalLine
            ) {
              row = new RowInfo();
          ...
          table.forEach(function (row) {
            if (
              ...
              var tableArea = table
                .filter(function (i) {
                  return (
                    i.CtrlLocation === row.CtrlLocation &&
                    ((i.Parent == null && row.Parent == null) ||
                      (i.Parent === row.Parent && i.AreaId === row.AreaId)) &&
                    i.Top >= row.Top &&
                    i.RowId != row.RowId &&
                    i.NextRow == null &&
                    !i.MightBeBackground
      ...
      },
      {
        ...
        value: function GetOverflowStartIndex(row) {
          ...
          for (var i = 0; i < cellsLayout.length; i++) {
            ...
            if (
              cell.ZoomRight >
              firstCell.Cell.AdjustControlInfo.ParentWidthSubPadding
            ) {
              return i;
            }
          }
    ...
    [
      {
        ...
        value: function InitCtrl(domEle) {
          ...
          if (
            (ctrlName === "slideset" || ctrlName === "fullpageSlide") &&
            (styleName === "Style1" || styleName === "Style3")
          ) {
      ...
      },
      {
        key: "Init",
        value: function Init() {
          CtrlAdjuster.MainEle.find("[ctype=newsItemContentBind]").each(
            function (a, b) {
              $(b)
                .find("[ctype]")
                .each(function (x, y) {
          ...
          var ctrlList = headerCtrlList
            .concat(mainCtrlList)
            .concat(footerCtrlList);
          var self = this;
          var ctrls = [];
          baseAdjuster.ShowHiddenCtrls(function (scope) {
        ...
        value: function HandleVirtualContainer(ctrls) {
          function NoiseFilter() {
            ...
            ctrlTable.forEach(function (row) {
              ...
              row.Cells.forEach(function (ctrl) {
                ...
                if (
                  sameColumnCtrls.length > 1 &&
                  ctrl.CtrlName === "image" &&
                  (ctrl.Width >= 500 || ctrl.Height >= 500) &&
                  !ctrl.IsVirtualContainer
                ) {
              ...
              row.Cells.forEach(function (ctrl) {
                ...
                if (sameColumnCtrls.length > 1) {
                  ...
                  var left = Math.min.apply(
                    Math,
                    sameColumnCtrls.map(function (x) {
                      return x.Left;
                    })
                  );
          ...
          function HandleMulticolumnVirtualItem() {
            ...
            ctrls
              ...
              .forEach(function (parentCtrlInfo) {
                var liList = parentCtrlInfo.ControlView.find("ul")
                  .eq(0)
                  .children();
                var left = 0;
          ...
          function HandleSlidesetItem() {
            ctrls
              .filter(function (i) {
                return (
                  i.CtrlName == "slideset" || i.CtrlName == "fullpageSlide"
                );
              })
              .forEach(function (parentCtrlInfo) {
              ...
              .forEach(function (line) {
                if (line.CtrlAdjuster.IsVerticalLine) {
                  ...
                  var ctrlFilter = ctrls.filter(function (i) {
                    return (
                      !(i.MightBeBackground || i.IsFullRowCtrl) &&
                      i.CtrlLocation == line.CtrlLocation &&
                      ((i.ParentId == null && line.ParentId == null) ||
                        (i.ParentId == line.ParentId &&
                          i.AreaId == line.AreaId)) &&
                      i.Top + AdjustConfig.IntersectOffset <
                        line.DisplayBottom &&
                      line.Top + AdjustConfig.IntersectOffset < i.DisplayBottom
                    );
                  });
                  //AdjustHelper.Debugger(line, "con_34_51");
                  var leanOnCtrl = ctrlFilter
                    .filter(function (i) {
                  ...
                  if (leanOnCtrl) {
                    ...
                    line.CtrlAdjuster.LeanOnPadding =
                      leanOnCtrl.DisplayRight - line.Left;
                  } else {
                    leanOnCtrl = ctrlFilter
                      .filter(function (i) {
                    ...
                    if (leanOnCtrl) {
                      ...
                      line.CtrlAdjuster.LeanOnPadding =
                        leanOnCtrl.Left - line.DisplayRight;
                    }
                  }
                }
              });
              ...
              .forEach(function (parentCtrlInfo) {
                switch (parentCtrlInfo.StyleName) {
                  ...
                  case "Style11": {
                    ...
                    var width = parentCtrlInfo.ControlView.find(".smAreaC")
                      .eq(0)
                      .width();
          ...
          function ConvertCtrl2VirtualContainer() {
            var mightBeVirtualContainerCtrlNameList = [
              "button",
              "image",
              "text",
            ];
            ctrls.forEach(function (ctrl) {
              var mightBeVirtualContainerCtrlList = ctrls
                .filter(function (i) {
                  return (
                    mightBeVirtualContainerCtrlNameList.indexOf(i.CtrlName) !==
                      -1 &&
                    i.CtrlLocation == ctrl.CtrlLocation &&
                    i.ParentId === ctrl.ParentId &&
                    i.AreaId === ctrl.AreaId &&
    ...
    [
        ...
        value: function CtrlStandardDetect() {
          var result = {
            ...
            ShowTips: function ShowTips() {
              return (
                this.IntersectionCtrlIdList.length != 0 ||
          ...
          try {
            var headerCtrlList = CtrlAdjuster.HeaderEle.find(
              "[ctype]:not(.smart-deleted)"
            ).toArray();
            var mainCtrlList = CtrlAdjuster.MainEle.find(
              "[ctype]:not(.smart-deleted)"
            ).toArray();
            var footerCtrlList = CtrlAdjuster.FooterEle.find(
              "[ctype]:not(.smart-deleted)"
            ).toArray();
            headerCtrlList.forEach(function (i) {
              return $(i).attr("ctrl-location", "header");
            ...
            ctrls
              ...
              .forEach(function (ctrlA) {
                ctrls.forEach(function (ctrlB) {
                  if (
                    CtrlAdjuster.IsInSameArea(ctrlA, ctrlB) &&
                    ctrlA !== ctrlB &&
                    //已经存在的则跳过
                    ...
                    if (
                      ctrlA.Top < ctrlB.Bottom &&
                      ctrlB.Top < ctrlA.Bottom &&
                      ctrlA.Left < ctrlB.Right &&
                      ctrlB.Left < ctrlA.Right
                    ) {
                      result.IntersectionCtrlIdList.push([
                        {
                          CtrlId: ctrlA.CtrlId,
                          ElementId: ctrlA.ElementId,
                          CtrlName: ctrlA.CtrlName,
                        },
                        {
                          CtrlId: ctrlB.CtrlId,
                          ElementId: ctrlB.ElementId,
                          CtrlName: ctrlB.CtrlName,
                        },
                      ]);
                    }
                  }
            ...
            ctrls.forEach(function (ctrl) {
              ...
              var parentWidth = parent
                ? parent.Width
                : ctrl.ControlView.parents().find(".smvContainer").width();
              if (parentWidth < ctrl.Right || ctrl.Left < 0) {
                if (
                  AdjustConfig.FullRowCtrlNames.indexOf(ctrl.CtrlName) === -1
                ) {
                  result.OverflowCtrlIdList.push({
                    ...
                    CtrlId: ctrl.CtrlId,
                    Offset:
                      ctrl.Left < 0 ? ctrl.Left : ctrl.Right - parentWidth,
              ...
              if (
                ...
                !(
                  parent &&
                  parent.CtrlName === "tab" &&
                  (parent.StyleName === "Style3" ||
                    parent.StyleName === "Style4" ||
                    parent.StyleName === "Style5")
                ) &&
                (offset <=
                  parentWidth * AdjustConfig.MaxOffsetNotCenterPercent ||
                  offset < 10) &&
                ctrls.find(function (i) {
                  return (
                    CtrlAdjuster.IsInSameArea(ctrl, i) &&
                    ctrl.Top < i.Bottom &&
                    i.Top < ctrl.Bottom &&
                    i.CtrlId !== ctrl.CtrlId
                  );
                ...
                result.NotCenterCtrlInfoList.push({
                  ...
                  CtrlName: ctrl.CtrlName,
                  Left:
                    ctrl.Left > parentWidth - ctrl.Right
                      ? AdjustHelper.ToFixed(ctrl.Left - offset / 2)
                      : AdjustHelper.ToFixed(ctrl.Left + offset / 2),
                  ShowBtn:
                    ctrl.IsTemplateCtrl && CtrlAdjuster.MainEle.length > 0
                      ? false
                      : true,
                });
              }
                ...
                arr.forEach(function (itemA) {
                  arr.forEach(function (itemB) {
                    if (itemA !== itemB) {
                      //不在同一行
                      if (
                        !(itemA.Top < itemB.Bottom && itemB.Top < itemA.Bottom)
                      ) {
                        result.MulitRowCtrlIdMap[ctrlA.CtrlId] = result
                          .MulitRowCtrlIdMap[ctrlA.CtrlId] || {
                          CtrlName: ctrlA.CtrlName,
                          CtrlInfoList: [],
                        };
                        if (
                          !result.MulitRowCtrlIdMap[
                            ctrlA.CtrlId
                          ].CtrlInfoList.some(function (x) {
                          ...
                          result.MulitRowCtrlIdMap[
                            ...
                            CtrlId: itemA.CtrlId,
                            ElementId: itemA.ElementId,
                            CtrlName: itemA.CtrlName,
                          });
                        }
                      }
                    }
        ...
        value: function DetectIsFullRowCtrl(ctrls, tooWideIsFullRow) {
          ctrls.forEach(function (ctrl) {
            ...
            if (
              tooWideIsFullRow &&
              ctrl.Width >=
                CtrlAdjuster.GetOriPageWidth() -
                  AdjustConfig.MinDocumentXPadding * 2
            ) {
              ctrl.IsFullRowCtrl = true;
              return;
            }
        ...
        value: function ResetSlider(
          ...
          if (jssorCache) {
            ...
            if (jssorCache.Html) {
              ...
              var html = jssorCache.Html.replace(
                /"\)\.cutFill\("/g,
                '").attr("duplicateCutFill_'
              );
              $("#" + jssorCache.SliderId)
                .parent()
                .html(html);
            ...
            jssorCache.Jssor = new $JssorSlider$(
              jssorCache.SliderId,
              jssorCache.JssorOpt
            );
            // new 实例之后需要重新注册事件
      ...
      },
      {
        ...
        value: function ResizeCallback(ctrlId, delay) {
          var resizeCache = LayoutConverter.CtrlJsVariableList.find(function (
            i
          ) {
            return i.CtrlId === ctrlId;
          });
...
function LaunchLayoutConverter(notCallResizeFunc) {
  function needLazyLoad() {
    return (
      window.location.pathname.toLowerCase().startsWith("/newsinfo") ||
      window.location.pathname.toLowerCase().startsWith("/productinfo") ||
      window.location.pathname
        .toLowerCase()
        .startsWith("/prevnewscontentpage") ||
      window.location.pathname
        .toLowerCase()
        .startsWith("/prevproductcontentpage")
    );
  }
