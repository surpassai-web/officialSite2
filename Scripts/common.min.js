...
$(function () {
    ...
    var taobaoUrl =
        "https://s.click.taobao.com/t?e=m%3D2%26s%3DJvDoTxVU%2FaIcQipKwQzePCperVdZeJviEViQ0P1Vf2kguMN8XjClAjWRN9Qgu1TChTHH3SLdpkB%2B%2BZdddB%2Fw0OU2ypSedH3JmivXcocEXpwHe3wpMV0Nd1eCyZVRWUMRiYWStHE%2B0ceFSvfO0N66nzO5MaXTjVACyw%2Bb0Sl2aPhWYetMiZZgV1Jkp%2BJs%2BBdiHCfeuY4QgTDGDF1NzTQoPw%3D%3D";
    var oldTaobaoUrl =
        "https://ac.aliyun.com/application/webdesign?source=5176.11533457&userCode=4kxgpnsp";
    var newUrl =
        "https://wanwang.aliyun.com/webdesign/webdesign?source=5176.11533457&userCode=i7rzleoi";
    if ($("#Poweredby")) {
        if (
            oldurl &&
            (oldurl == "http://www.clouddream.net/" ||
                oldurl == "https://www.aliyun.com/product/ecs" ||
                oldurl ==
                "https://ac.aliyun.com/application/webdesign?source=5176.11533457&userCode=yg0w1bfe&type=copy" ||
                oldurl == taobaoUrl ||
                oldurl == oldTaobaoUrl)
        ) {
    ...
    if ($(".powerby-area")) {
        ...
        if (length === 0) {
            ...
            if (
                powerOldUrl &&
                (powerOldUrl == "http://www.clouddream.net/" ||
                    powerOldUrl == "https://www.aliyun.com/product/ecs" ||
                    oldurl ==
                    "https://ac.aliyun.com/application/webdesign?source=5176.11533457&userCode=yg0w1bfe&type=copy" ||
                    powerOldUrl == taobaoUrl ||
                    powerOldUrl == oldTaobaoUrl)
            ) {
...
+(function ($, window) {
    ...
    $.fn.cutFill = function (imgWidth, imgHeight, needmf, cb, isAuto) {
        ...
        this.each(function () {
            ...
            var isReset = false;
            if (
                typeof widthCopy === "undefined" &&
                typeof heightCopy === "undefined"
            ) {
                if ($this.attr("autoFill") == "ok") {
                    $this
                        .css("width", "")
            ...
            if (width > height * vs) {
                $this
                    ...
                    .css(
                        "marginTop",
                        halfIntHeight -
                        (halfIntWidth * parseInt(realHeight)) / parseInt(realWidth) +
                        "px"
                    );
            } else {
                if (needmf || typeof needmf == "undefined") {
                    $this
                        ...
                        .css(
                            "marginLeft",
                            halfIntWidth -
                            (halfIntHeight * parseInt(realWidth)) / parseInt(realHeight) +
                            "px"
                        );
                } else {
    ...
    (function ($) {
        ...
        wzArticleCrumbs = function () {
            ...
            this.init = function (opt) {
                ...
                if (this.options.isHideTitle) {
                    ...
                    if (
                        notSkipCtrlType.indexOf(
                            $("#" + this.options.controlId).attr("ctype")
                        ) != -1
                    )
                        return false;
                }
                ...
                if (
                    referrer != undefined &&
                    referrer != "" &&
                    referrer.indexOf(origin) > -1
                ) {
                    var pathName = referrer
                        .substring(origin.length, referrer.length)
                        .toLowerCase();
                    var originPathName = referrer
                        .substring(origin.length, referrer.length)
                        .toLowerCase();
                    ...
                    var hisHeight = $(
                        "#" + this.options.controlId + " .w-crumbs"
                    ).height();
                    var homeItemTitle = $(
                        "#" + this.options.controlId + " .w-crumbs-item:first"
                    ).text();
                    if (reg.test(pathName)) {
                        ...
                        if (value != null && value != homeItemTitle) {
                            var html = "";
                            var splitIcon = $(
                                "#" + this.options.controlId + " .w-crumbs i:first"
                            );
                            if (splitIcon.length > 0) {
                                html +=
                                    '&nbsp;<i class="' +
                                    $(splitIcon).attr("class").replace("f-hide", "") +
                                    '">' +
                                    $(splitIcon).html() +
                                    "</i>";
                            }
                            ...
                            if (!this.options.isHideTitle) {
                                $(
                                    "#" + this.options.controlId + " a.w-crumbs-item:first"
                                ).after(html);
            ...
            this.smrecompute = function (hisH) {
                ...
                $("#" + this.options.controlId).smrecompute("recomputeTo", [
                    tabContentHeight,
                    hisH,
                ]);
            };
        ...
        $.fn.smartNPCrumbsControl = function (opt) {
            if (wzArticleCrumbs[opt]) {
                return wzArticleCrumbs[opt].apply(
                    this,
                ...
                $.error(
                    "Method " +
                    method +
                    " does not exist on jQuery.wzArticleCrumbsControl"
                );
            }
        };
    })(jQuery);
+(function ($) {
    ...
    wzQuantity = function () {
        ...
        this.init = function (opt) {
            ...
            this._quantityElement = $(
                "#" + this.options.controlId + " ." + this.options.quantity
            );
            this._minusElement = $(
                "#" + this.options.controlId + " ." + this.options.minus
            );
            this._plusElement = $(
                "#" + this.options.controlId + " ." + this.options.plus
            );
            this._bindEvent();
        };
    ...
    $.fn.wzQuantitySmartControl = function (opt) {
        if (wzQuantity[opt]) {
            ...
            $.error(
                "Method " + method + " does not exist on jQuery.wzQuantitySmartControl"
            );
        }
    };
})(jQuery);
+(function ($) {
    ...
    wzComment = function () {
        ...
        this.refreshCommentCaptcha = function (targetImg, index) {
            ...
            $(targetImg).attr(
                "src",
                "/Common/GenerateCommentCaptcha?timestamp=" +
                this.options["Timestamp" + index]
            );
        };
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.IsAllowComments) {
                        var $UserInfo = $(
                            "#" + self.options.controlId + " .w-comment-loginInfo"
                        );
                        var $CommentCaptcha = $(
                            "#" + self.options.controlId + " .w-comment-code"
                        );
                        if (result.IsLogin) {
                        ...
                        //加载评论验证码
                        self.refreshCommentCaptcha(
                            $(
                                "#" +
                                self.options.controlId +
                                " .w-comment-top img.validCodeImg"
                            ),
                            0
                        );
                    } else {
                ...
                success: function (result) {
                    if (result.IsSuccess) {
                        ...
                        $(
                            "#" +
                            self.options.controlId +
                            " .w-comment-bottom .w-comment-num .text"
                        ).text(result.total);
                        var html = "";
                        ...
                        for (var i = 0; i < list.length; i++) {
                            ...
                            html +=
                                '<div class="w-comment-list-item" commentId=' + item.Id + ">";
                            html +=
                                '    <div class="w-comment-list-user" style="' +
                                (self.options.isShowAvatar ? "" : "display:none") +
                                '">';
                            html +=
                                '       <img alt="" src="' + item.CommentUserAvatar + '">';
                            html += "       </div>";
                            html += '       <div class="w-comment-list-con">';
                            html +=
                                '           <div class="w-comment-list-time"><span class="w-fl">' +
                                item.CommentUserName +
                                '</span> <span class="w-fr">' +
                                item.CreateDatetime +
                                "</span></div>";
                            html +=
                                '           <div class="w-comment-list-des' +
                                (item.CommentUserIsAdmin ? " w-comment-list-des-admin" : "") +
                            ...
                            if (
                                ...
                                for (var j = 0; j < item.Reply.length; j++) {
                                    ...
                                    html +=
                                        '        <div class="w-comment-talk-name w-fl">' +
                                        reply.CommentUserName +
                                        "：</div>";
                                    html +=
                                        '        <div class="w-comment-talk-info"  style="white-space: pre-line;">' +
                                        "\n" +
                                        reply.CommentText +
                                        "</div>";
                                    html += "    </div>";
                            ...
                            html +=
                                '           <div class="w-comment-list-reply f-clearfix"><a href="javascript:void(0)" class="toggleReply"><i class="mw-iconfont" style="' +
                                (self.options.isShowReplyIcon ? "" : "display:none") +
                                '">' +
                                self.options.replyIcon +
                                "</i> " +
                                self.options.replyText +
                                "</a></div>";
                            html +=
                                '           <div class="w-comment-list-reply-cont" style="display:none">';
                            html +=
                                '               <div class="w-comment-cont"><textarea name="replyText" rows="10" maxlength="400" placeholder="' +
                                self.options.replyText +
                                " " +
                                item.CommentUserName +
                                '："></textarea> <span class="words"><span>0</span>/400</span></div>';
                            html += '               <div class="w-comment-operate clearfix">';
                            html += '                   <div class="w-comment-code">';
                            html +=
                                '                       <input type="text" class="w-comment-code-input">';
                            html +=
                                '                           <a class="change-another-one" href="javascript:void(0)" title="' +
                                self.options.changeCaptchaText +
                                '"><img class="validCodeImg" src="./Content/images/code.png" height="26"></a>';
                            html += "                   </div>";
                            html +=
                                '                   <div class="w-comment-button"><a href="javascript:void(0)">' +
                                self.options.summitText +
                                "</a></div>";
                            html += "                       </div>";
                            html += "                   </div>";
                            html += "               </div>";
                        ...
                        $(
                            "#" +
                            self.options.controlId +
                            " .w-comment-bottom .w-comment-list"
                        ).html(html);
        ...
        this.bindEvent = function () {
            ...
            $("#" + this.options.controlId + " .w-comment-top img.validCodeImg").on(
                "click",
                function () {
            ...
            //切换回复评论窗口显示
            $("#" + this.options.controlId + " .w-comment-bottom .w-comment-list").on(
                "click",
                "a.toggleReply",
                function () {
                    var hisH = $("#" + self.options.controlId + " .w-comment").height();
                    if ($(this).parent().next().is(":hidden")) {
                        if (!self.options.isLogin) {
                            ...
                            if (
                                codeImg.attr("src").toLowerCase() ==
                                "./Content/images/code.png"
                            ) {
                                var index = $(
                                    "#" +
                                    self.options.controlId +
                                    " .w-comment-bottom .w-comment-list img.validCodeImg"
                                ).index(codeImg);
                                index = index + 1;
            ...
            //注销
            $(
                "#" + this.options.controlId + " .w-comment-top .w-comment-loginInfo"
            ).on("click", "a.quit", function () {
                self.ajaxLogout();
            });
        ...
        this.submitReply = function () {
            var data = this.serializePostData();
            var validCodeImg = $(this.options.eventSource)
                .parent()
                .prev()
                .find(".validCodeImg");
            var index = $(
            ...
            index = index + 1;
            data.Timestamp = this.options["Timestamp" + index];
            data.AtCommentId = $(this.options.eventSource)
                .parents(".w-comment-list-item")
                .attr("commentid");
            var checkFlag = this.checkPostData(data);
            if (checkFlag) {
                data.CommentText = escape(data.CommentText);
        ...
        this.checkPostData = function (data) {
            ...
            if ($.trim(data.CommentText) == "") {
                if (type == "comment") {
                    this.showError(
                        this.getCurrentCommentElement(),
                        this.options.commentTextEmpty
                    );
                } else {
                    this.showError(
                        this.getCurrentCommentElement(),
                        this.options.replyTextEmpty
                    );
                }
                return false;
            } else {
                if (data.CommentText.length > 400) {
                    if (type == "comment") {
                        this.showError(
                            this.getCurrentCommentElement(),
                            this.options.commentTextMaxLength
                        );
                    } else {
                        this.showError(
                            this.getCurrentCommentElement(),
                            this.options.replyTextMaxLength
                        );
                    }
                    return false;
                }
            ...
            if ($.trim(data.Captcha) == "") {
                if (type == "comment") {
                    if (!this.options.isLogin) {
                        this.showError(
                            this.getCurrentCaptchaElement(),
                            this.options.captchaEmpty
                        );
                        return false;
                    }
                } else {
        ...
        this.smrecompute = function (hisH) {
            var tabContentHeight = $(
                "#" + this.options.controlId + " .w-comment"
            ).height();
            $("#" + this.options.controlId).smrecompute("recomputeTo", [
                tabContentHeight,
                hisH,
                    ...
                    if (result.IsSuccess) {
                        ...
                        if (typeof result.validate != "undefined") {
                            if (result.target == "Captcha") {
                                self.showError(
                                    self.getCurrentCaptchaElement(),
                                    result.validate
                                );
                            }
                            if (result.target == "Comment" || result.target == "Reply") {
                                self.showError(
                                    self.getCurrentCommentElement(),
                                    result.validate
                                );
                            }
                        }
        ...
        this.clearError = function () {
            $("#" + this.options.controlId + " .w-haserror").removeClass(
                "w-haserror"
            );
        ...
        this.showError = function (target, message) {
            ...
            $(target)
                ...
                .parent()
                .append(
                    '<span class="notifi"><i class="mw-iconfont">끸</i>' +
                    message +
                    "</span>"
                );
        ...
        this.getCurrentUser = function () {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    var $CommentCaptcha = $(
                        "#" + self.options.controlId + " .w-comment-top .w-comment-code"
                    );
                    if (result.IsLogin) {
                        $UserInfo.find("img").attr("src", result.Avatar);
                        $UserInfo.find(".name").text(result.UserName);
        ...
        this.onPageChange = function (pageIndex, type) {
            if (type == "change") {
                if (
                    pageIndex <= 0 ||
                    pageIndex == that.options.pageIndex ||
                    pageIndex > that.options.totalPageCount
                ) {
                    return;
                }
    ...
    $.fn.smartNPCommentControl = function (opt) {
        if (wzComment[opt]) {
            ...
            $.error(
                "Method " + method + " does not exist on jQuery.smartNPCommentControl"
            );
        }
    };
})(jQuery);
+(function ($) {
    ...
    wzLeaveword = function () {
        ...
        this.init = function (opt) {
            $.extend(this.options, opt || {});
            this.options.$subjectElement = $(
                "#" + this.options.controlId + " input[name='Subject']"
            );
            if (
                $("#" + this.options.controlId + " textarea[name='Message']").length > 0
            ) {
                this.options.$messageElement = $(
                    "#" + this.options.controlId + " textarea[name='Message']"
                );
            } else {
                this.options.$messageElement = $(
                    "#" + this.options.controlId + " input[name='Message']"
                );
            }
            this.options.$emailElement = $(
                "#" + this.options.controlId + " input[name='Email']"
            );
            this.options.$captchaElement = $(
                "#" + this.options.controlId + " input[name='Captcha']"
            );
            this.options.$submitElement = $(
                "#" + this.options.controlId + " a[name='Submit']"
            );
            this.options.$resetElement = $(
                "#" + this.options.controlId + " a[name='Reset']"
            );
            ...
            $("#" + this.options.controlId + " .w-item-textarea").height(
                $(
                    "#" + this.options.controlId + " .w-guestbook-both-left"
                ).outerHeight() - 12
            );
        ...
        this.refreshLeavewordCaptcha = function () {
            ...
            $("#" + this.options.controlId + " img").attr(
                "src",
                "/Common/GenerateLeavewordCaptcha?timestamp=" +
        ...
        this.checkPostData = function (data) {
            ...
            if ($.trim(data.Subject) == "") {
                this.showError(
                    this.options.$subjectElement,
                    this.options.emptyPrefix +
                    " " +
                    this.getElementTitle(this.options.$subjectElement)
                );
                return false;
            } else {
            ...
            if ($.trim(data.Message) == "") {
                this.showError(
                    ...
                    this.options.emptyPrefix +
                    " " +
                    this.getElementTitle(this.options.$messageElement)
                );
                return false;
            }
            ...
            if ($.trim(data.Email) == "") {
                this.showError(
                    ...
                    this.options.emptyPrefix +
                    " " +
                    this.getElementTitle(this.options.$emailElement)
                );
                return false;
            }
            //留言控件不在验证邮箱格式
            ...
            if ($.trim(data.Captcha) == "") {
                this.showError(
                    ...
                    this.options.emptyPrefix +
                    " " +
                    this.getElementTitle(this.options.$captchaElement)
                );
                return false;
            }
        ...
        this.showError = function (target, message) {
            this.clearError();
            if (
                this.options.style == "Style6" &&
                $(target).attr("name") == "Message"
            ) {
        ...
        this.getElementTitle = function (target) {
            ...
            if (this.options.controlType == "Pc") {
                if (this.options.style == "Style1") {
                    ...
                    this.options.style == "Style4" ||
                    this.options.style == "Style5" ||
                    this.options.style == "Style6"
                ) {
                    return target.attr("placeHolder");
                }
...
+(function ($) {
    ...
    wzMobileComment = function () {
                ...
                success: function (result) {
                    if (result.IsAllowComments) {
                        var $UserInfo = $(
                            "#" +
                            self.options.controlId +
                            " .mw-comment-dialogue-cont .mw-comment-loginInfo"
                        );
                        var $CommentCaptcha = $(
                            "#" +
                            self.options.controlId +
                            " .mw-comment-dialogue-cont .mw-comment-code"
                        );
                        if (result.IsLogin) {
                            $UserInfo.find("img").attr("src", result.Avatar);
                            $UserInfo.find(".name").text(result.UserName);
                        ...
                        self.refreshCommentCaptcha(
                            $(
                                "#" +
                                self.options.controlId +
                                " .mw-comment-dialogue-cont img.validCodeImg"
                            ),
                            0
                        );
                    } else {
                    ...
                    if (result.IsSuccess) {
                        $.get(
                            ...
                            function (token) {
                                $('input[name="__RequestVerificationToken"]').val(token.token);
                                var $UserInfo = $(
                                    "#" + self.options.controlId + " .mw-comment-loginInfo"
                                );
                                var $CommentCaptcha = $(
                                    "#" + self.options.controlId + " .mw-comment-code"
                                );
        ...
        this.loadCommentList = function (goToComemnt) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.IsSuccess) {
                        var hisH = $(
                            "#" + self.options.controlId + " .mw-comment"
                        ).height();

                        $("#" + self.options.controlId + " .mw-comment-num .text").text(
                            result.total
                        );
                        var html = "";
                        var list = result.rows;
                        for (var i = 0; i < list.length; i++) {
                            ...
                            html +=
                                '<div class="mw-comment-list-item" commentId=' + item.Id + ">";
                            html +=
                                '    <div class="mw-comment-list-user" style="' +
                                (self.options.isShowAvatar ? "" : "display:none") +
                                '">';
                            html +=
                                '       <img alt="" src="' + item.CommentUserAvatar + '">';
                            ...
                            html +=
                                '           <div class="mw-comment-list-time"><span class="mw-fr">' +
                                item.CreateDatetime +
                                '</span><span class="mw-fl">' +
                                item.CommentUserName +
                                "</span></div>";
                            html +=
                                '           <div class="mw-comment-list-des' +
                                (item.CommentUserIsAdmin ? " mw-comment-list-des-admin" : "") +
                                '" style="white-space: pre-line;">' +
                                item.CommentText +
                                "</div>";
                            if (
                                ...
                                for (var j = 0; j < item.Reply.length; j++) {
                                    ...
                                    html +=
                                        '        <div class="mw-comment-talk-name mw-fl">' +
                                        reply.CommentUserName +
                                        "：</div>";
                                    html +=
                                        '        <div class="mw-comment-talk-info"  style="white-space: pre-line;">' +
                                        "\n" +
                                        reply.CommentText +
                                        "</div>";
                                    html += "    </div>";
                            ...
                            html +=
                                '           <div class="mw-comment-list-reply f-clearfix"><a href="javascript:void(0)" class="toggleReply"><i class="mw-iconfont" style="' +
                                (self.options.isShowReplyIcon ? "" : "display:none") +
                                '">' +
                                self.options.replyIcon +
                                "</i> " +
        ...
        this.bindEvent = function () {
            ...
            //切换回复评论窗口显示
            $("#" + this.options.controlId + " .mw-comment-list").on(
                "click",
                "a.toggleReply",
                function () {
                    self.options.eventSource = this;
            ...
            $(
                "#" +
                this.options.controlId +
                " .mw-comment-dialogue-cont .mw-comment-button"
            ).on("click", function () {
                if (self.options.isPosting) {
                    return false;
                }
            ...
            //弹出发表评论对话框
            $("#" + this.options.controlId + " .mw-comment-input").on(
                "click",
                function () {
                    if (self.options.isMustLogin) {
        ...
        this.serializePostData = function () {
            var data = {};
            data.CommentText = $("#" + this.options.controlId)
                .find("textarea")
                .val();
            data.CommentText = $.trim(data.CommentText);
            data.Captcha = $("#" + this.options.controlId)
                .find(".mw-comment-code-input")
                .val();
            data.EntityId = this.options.entityId;
            data.EntityType = this.options.entityType;
            return data;
        ...
        this.smrecompute = function (hisH) {
            var tabContentHeight = $(
                "#" + this.options.controlId + " .mw-comment"
            ).height();
            $("#" + this.options.controlId).smrecompute("recomputeTo", [
                tabContentHeight,
                hisH,
        ...
        this.showError = function (target, message) {
            this.clearError();
            $(
                "#" + this.options.controlId + " .mw-comment-dialogue .mw-comment-title"
            ).after(
                '<div class="notifi"><i class="mw-iconfont">끸</i>' + message + "</div>"
            );
        ...
        this.showReply = function () {
            if (this.options.isMustLogin && !this.options.isLogin) {
                ...
                var atCommentId = $(that)
                    .parents(".mw-comment-list-item")
                    .attr("commentid");
                var commentUser = $(that)
                    .parents(".mw-comment-list-con")
                    .find(".mw-comment-list-time")
                    .find(".mw-fl")
                    .text();
                $("#" + this.options.controlId + " textarea").attr(
                    "placeholder",
                    this.options.replyText + " " + commentUser + "："
                );
                $("#" + this.options.controlId + " textarea")
                    .next()
                    .find("span")
                    .text(0);
    ...
    $.fn.smartNPMobileCommentControl = function (opt) {
        if (wzMobileComment[opt]) {
            return wzMobileComment[opt].apply(
                this,
                Array.prototype.slice.call(arguments, 1)
            );
        } else if (typeof opt === "object" || !opt) {
            ...
            $.error(
                "Method " +
                method +
                " does not exist on jQuery.smartNPMobileCommentControl"
            );
        }
    };
})(jQuery);
+(function ($) {
    ...
    baiDuShare = function () {
        ...
        this.init = function (opt) {
            ...
            var data = {
                pageId:
                    parseInt($("#pageinfo").attr("data-type")) - 1 == 1
                        ? $("#pageinfo").val()
                        : $("#pageinfo").attr("data-entityid"),
    ...
    $.fn.smartShareControl = function (opt) {
        if (baiDuShare[opt]) {
            ...
            $("#smv_" + opt.controlId)
                .find("div[data-tag='" + opt.controlId + "']")
                .css("display", "");
...
+(function ($) {
    ...
    wzFavorite = function () {
        ...
        this.addFavorite = function () {
            ...
            AddToMyFavourite(
                ...
                function () {
                    ...
                    $("#smvSysFavoriteModal .mw-modal")
                        .removeClass("mw-fade")
                        .addClass("mw-fadein");
                    setTimeout(function () {
                        $("#smvSysFavoriteModal .mw-modal")
                            .removeClass("mw-fadein")
                            .addClass("mw-fade");
                    }, 1500);
                }
            );
        ...
        this.removeFavorite = function () {
            var self = this;
            var typeName =
                this.options.entityTypeName + this.options.removeFavouriteSucess;
            DeleteFromMyFavourite(
                this.options.entityId,
                this.options.entityType,
                function () {
                    $("#" + self.options.controlId + " .mw-collect").removeClass(
                        "mw-current"
                    );
                    $("#smvSysFavoriteModal .mw-smtips").text(typeName);
                    $("#smvSysFavoriteModal .mw-modal")
    ...
    $.fn.smartNPwzFavoriteControl = function (opt) {
        if (wzFavorite[opt]) {
            ...
            $.error(
                "Method " +
                method +
                " does not exist on jQuery.smartNPwzFavoriteControl"
            );
        }
    };
})(jQuery);
    ...
    if (pagerStyle.indexOf("Style1_") > -1) {
        ...
        $("#smv_" + htmlId + " #prePage").click(function () {
            ...
            var numberA = $(
                "#smv_" +
                htmlId +
                " #pagerHtml li[class !='dom'] a:not(a[class *='w-page-flip'])"
            );
...
function AssembleData(
    ...
    $.post(
        "/Designer/Common/GetData",
        param,
        function (data) {
            if (
                pagerStyle.indexOf("Style1_") > -1 ||
                pagerStyle.indexOf("Style2_") > -1
            ) {
                $("#ulList_" + htmlId + " li").remove();
                $.each(data.Data, function (i, o) {
                    $("#ulList_" + htmlId).append(
                        kino.razor($("#listTemplate_" + htmlId).html(), {
                            data: o,
                        })
                    );
                });
                ...
                $.each(data, function (i, item) {
                    if (type == "mobile") {
                        if (item["Id"] == stateProvinceId) {
                            obj.append(
                                '<li class="mw-address-item current" provinceId="' +
                                item["Id"] +
                                '" name="' +
                                item["Name"] +
                                '"><span class="mw-iconfont">&#xa018;</span><div>' +
                                item["Name"] +
                                "</div></li>"
                            );
                        } else {
                            obj.append(
                                '<li class="mw-address-item" provinceId="' +
                                item["Id"] +
                                '" name="' +
                                item["Name"] +
                                '"><span class="mw-iconfont">&#xa018;</span><div>' +
                        ...
                        if (item["Id"] == stateProvinceId) {
                            obj.append(
                                '<li class="w-address-conul-item w-address-current"provinceId="' +
                                item["Id"] +
                                '"><a class="w-address-conul-link">' +
                                item["Name"] +
                                "</a></li>"
                            );
                        } else {
                            obj.append(
                                '<li class="w-address-conul-item"provinceId="' +
                                item["Id"] +
                                '"><a class="w-address-conul-link">' +
                                item["Name"] +
                                "</a></li>"
            ...
            if (data != null) {
                $.each(data, function (i, item) {
                    if (type == "mobile") {
                        if (item["Id"] == cityId) {
                            obj.append(
                                '<li class="mw-address-item current" cityId="' +
                                item["Id"] +
                                '" name="' +
                                item["Name"] +
                                '"><span class="mw-iconfont">&#xa018;</span><div>' +
                            ...
                            obj.append(
                                '<li class="mw-address-item" cityId="' +
                                item["Id"] +
                                '" name="' +
                                item["Name"] +
                                '"><span class="mw-iconfont">&#xa018;</span><div>' +
                        ...
                        if (item["Id"] == cityId) {
                            obj.append(
                                '<li class="w-address-conul-item w-address-current" cityId="' +
                                item["Id"] +
                                '"><a class="w-address-conul-link">' +
                                item["Name"] +
                                "</a></li>"
                            ...
                            obj.append(
                                '<li class="w-address-conul-item" cityId="' +
                                item["Id"] +
                                '"><a class="w-address-conul-link">' +
                                item["Name"] +
                                "</a></li>"
            ...
            if (data != null) {
                $.each(data, function (i, item) {
                    if (type == "mobile") {
                        if (item["Id"] == cityId) {
                            obj.append(
                                '<li class="mw-address-item current" areaId="' +
                                item["Id"] +
                                '" name="' +
                                item["Name"] +
                                '"><span class="mw-iconfont">&#xa018;</span><div>' +
                            ...
                            obj.append(
                                '<li class="mw-address-item" areaId="' +
                                item["Id"] +
                                '" name="' +
                                item["Name"] +
                                '"><span class="mw-iconfont">&#xa018;</span><div>' +
                        ...
                        if (item["Id"] == cityId) {
                            obj.append(
                                '<li class="w-address-conul-item w-address-current" areaId="' +
                                item["Id"] +
                                '"><a class="w-address-conul-link">' +
                                item["Name"] +
                                "</a></li>"
                            ...
                            obj.append(
                                '<li class="w-address-conul-item" areaId="' +
                                item["Id"] +
                                '"><a class="w-address-conul-link">' +
                                item["Name"] +
                                "</a></li>"
...
function SetMultiNavSelectedStyle(navId) {
    ...
    $("#" + navId)
        ...
        .each(function () {
            ...
            var secondWrapper = $(this)
                .children(".navDropdownWrapper")
                .find(".nav-secondWrapper");
            if (secondWrapper.length > 0) {
                secondWrapper.each(function () {
                    ...
                    if (
                        $(this).children(".nav-thirdWrapper").find(".nav-thirdItem")
                            .length > 0
                    ) {
                        $(this)
                            .children(".nav-thirdWrapper")
                            .find(".nav-thirdItem")
                            .each(function () {
...
function InitImageSmv(controlId, width, styleHeight, fillType, imgEle) {
    ...
    if (fillType == "1") {
        ...
        var dst = {};
        dst = $("#div_" + controlId + " img").FixFill(
            parseInt($control.css("width")),
            realHeight,
            "",
            imgEle
        );
        ...
        if (realWidth > realHeight * vs) {
            $(img)
                ...
                .css(
                    "marginTop",
                    halfIntHeight -
                    (halfIntWidth * parseInt(natureHeight)) / parseInt(natureWidth) +
                    "px"
                )
                .css("marginLeft", "0px");
        } else {
            $(img)
                ...
                .css(
                    "marginLeft",
                    halfIntWidth -
                    (halfIntHeight * parseInt(natureWidth)) / parseInt(natureHeight) +
                    "px"
                )
                .css("marginTop", "0px");
        }
        ...
        $("#" + catId)
            ...
            .each(function () {
                ...
                if (categoryId == curId) {
                    $(this).addClass("on");
                    if (
                        $(this).parents('div[ctype="category"]').attr("cstyle") === "Style4"
                    ) {
                        $(this)
                            .parents(".w-category-list-item")
                            .find(".w-category-list-title .mw-iconfont")
                            .click();
...
function pagination(TagId, First, Last, Previous, Next, callback) {
    ...
    if (newContainer.html() != null) {
        var contents = newContainer
            .find("div")
            .html()
            .split("_ueditor_page_break_tag_");
        ...
        if (length != 1) {
            ...
            if (length > canSeePage) {
                paginationDiv.append(
                    ...
                    HtmlId +
                    " class='other_page'>" +
                    (First == null || First == undefined ? "首页" : First) +
                    "</span>"
                );
                paginationDiv.append(
                    "<span id=pre_page_" +
                    HtmlId +
                    " class='other_page'>" +
                    (Previous == null || Previous == undefined ? "上一页" : Previous) +
                    "</span>"
                );
            }
            for (var i = 0; i < length; i++) {
                paginationDiv.append(
                    "<a class='page' id=" + i + " >" + (i + 1) + "</a>"
                );
            }
            ...
            page.click(function () {
                ...
                if (length < canSeePage) {
                    ...
                    if (length >= canSeePage && currentId > Math.floor(canSeePage / 2)) {
                        ...
                        $(this).addClass("hover");
                        canSeePage % 2 === 0
                            ? ((leftIndex = currentId - canSeePage / 2 + 1),
                                (rightIndex = currentId + canSeePage / 2))
                            : ((leftIndex = currentId - Math.floor(canSeePage / 2)),
                                (rightIndex = currentId + Math.floor(canSeePage / 2)));
                        if (leftIndex > length - canSeePage) {
                            newContainer
                                .find(".page:gt(" + (length - canSeePage) + ")")
                                .show();
                            newContainer
                                .find(".page:lt(" + (length - canSeePage) + ")")
                                .hide();
                        } else {
                        ...
                        if (
                            length >= canSeePage &&
                            currentId <= Math.floor(canSeePage / 2)
                        ) {
                            page.removeClass("hover");
                            newContainer.find("div:eq(0)").html(contents[currentId]);
                            $(this).addClass("hover");
                ...
                if (length > canSeePage) {
                    var currentPageId =
                        parseInt(newContainer.find(".hover").attr("id")) + 1;
            ...
            if (length > canSeePage) {
                ...
                paginationDiv.append(
                    ...
                    HtmlId +
                    " class='other_page'>" +
                    (Next == null || Next == undefined ? "下一页" : Next) +
                    "</span>"
                );
                paginationDiv.append(
                    "<span id=last_page_" +
                    HtmlId +
                    " class='other_page'>" +
                    (Last == null || Last == undefined ? "尾页" : Last) +
                    "</span>"
                );
            }
...
function DeleteFromMyFavourite(entityId, entityType, callback) {
    ...
    /// <returns></returns>
    $.post(
        "/customer/MyFavouriteDeleteByEntityId",
        { id: entityId, type: entityType },
        function (data) {
            if (typeof callback == "function") {
                callback();
...
function AddToMyFavourite(entityIds, entityType, callback, trigger) {
    ...
    $.post(
        "/customer/MyFavouriteAdd",
        { ids: entityIds, type: entityType, trigger: trigger },
        function (data) {
            if (typeof callback == "function") {
    ...
    switch (style.toLowerCase().substring(0, 6)) {
        case "style1":
            ...
            return {
                ...
                firsthtml: "",
                prevhtml:
                    "<li class='w-page-cm w-page-flip'><a href='javascript:void(0);'><span>{{prev}}</span><i>&lt;</i></a></li>",
                nexthtml:
                    "<li class='w-page-cm w-page-flip'><a href='javascript:void(0);'><span>{{next}}</span><i>&gt;</i></a></li>",
                lasthtml: "",
                pagehtml:
                    "<li class='w-page-cm'><a href='javascript:void(0);'>{{page}}</a></li>",
        ...
        case "style2":
            ...
            return {
                ...
                lasthtml: "",
                pagehtml:
                    "<li class='w-page-cm'><em>{{page}}</em>/<em>{{totalPages}}</em></li>",
                afterhtml:
                    "<li><span class='w-line-height-ie7'>{{goto}}</span><input type='text' jp-data='go'></li><li class='w-page-cm w-page-flip'><a href='javascript:void(0);' jp-role='go' id='goPage'>{{go}}</a></li>",
                wrapperhtml: "<ul class='" + colorStyle + " w-clearfix'></ul>",
                vpage: 1,
            };
        case "style3":
            ...
            return {
                ...
                prevhtml: "",
                nexthtml:
                    "<a href='javascript:void(0);' class='w-page-more " +
                    colorStyle +
                    "' jp-role='more'>{{more}}</a>",
                lasthtml: "",
                pagehtml: "",
    ...
    switch (style.toLowerCase().substring(0, 6)) {
        case "style1":
            ...
            return {
                ...
                firsthtml: "",
                prevhtml:
                    "<li class='mw-w25'><a href='javascript:void(0);' class='mw-previous " +
                    colorStyle +
                    "'><span>{{prev}}</span><i>&lt;</i></a></li>",
                nexthtml:
                    "<li class='mw-w25'><a href='javascript:void(0);' class='mw-previous " +
                    colorStyle +
                    " mw-fright'><span>{{next}}</span><i>&gt;</i></a></li>",
                lasthtml: "",
                pagehtml: "",
                afterhtml:
                    "<li class='mw-w50'><em>{{page}}</em>/<em>{{totalPages}}</em></li>",
                wrapperhtml: "<ul></ul>",
                vpage: 1,
            };
        case "style2":
            ...
            return {
                ...
                prevhtml: "",
                nexthtml:
                    "<a href='javascript:void(0);' class='mw-page-more " +
                    colorStyle +
                    "' jp-role='more'>{{more}}</a>",
                lasthtml: "",
                pagehtml: "",
...
function xnPagerCommon(pagerId, url) {
            ...
            switch (device + "_" + style) {
                ...
                case "mobile_style1":
                    ...
                    if (
                        (document.documentElement.scrollTop ||
                            window.pageYOffset ||
                            document.body.scrollTop) > $("#ulList_" + htmlId).offset().top
                    ) {
    ...
    var buildItem = function (html, pagedata) {
        if (html) {
            return html
                .replace(/{{first}}/g, pager.attr("jp-first"))
...
function xFilterRefresh(pageIndex) {
    var pager = $(
        ".esmartMargin[ctype=listproductcategory],.esmartMargin[ctype=listproductsearch]"
    ).find(".xn-pager");
    if (pager.attr("jp-enable") == "false") {
        return;
    }
...
(function ($) {
    $.fn.getxnresizeheight = function () {
        var height = 0;
        $(this)
            .find(">.yibuFrameContent>.xn-resize")
            .each(function () {
...
function JPlaceHolder(fn) {
    var PlaceHolder = {
        ...
        //refix
        fix: function (fn) {
            jQuery(".w-placeholder > :input[placeholder]").each(function (
                index,
                element
            ) {
                var self = $(this),
                ...
                success: function (result) {
                    if (result.IsSuccess) {
                        ...
                        win.location.href = href
                            .replace("?yibu_IsMobileDevice=true", "")
                            .replace("&yibu_IsMobileDevice=true", "");
                    }
                },
                error: function () { },
...
+(function ($) {
    ...
    wzDialog = function () {
        ...
        this.bindEvent = function () {
            var self = this;
            $("#" + this.options.controlId + " .w-modal").on(
                "click",
                ".w-modal-close",
                function () {
                    self.close();
            ...
            $("#" + this.options.controlId + "_dialog_modal_mask").on(
                "click",
                function () {
        ...
        this.close = function () {
            ...
            dialog.fadeOut(self.options.delayed, function () {
                dialog.find("div[ctype='music']").each(function () {
                    ...
                    var musicSmartView = $.getAudio(
                        "#" + musicContrilId + " .music_1 .lz-audio"
                    );
    ...
    $.fn.smartNPwzDialogControl = function (opt) {
        if (wzDialog[opt]) {
            ...
            $.error(
                "Method " + method + " does not exist on jQuery.smartNPwzDialogControl"
            );
        }
    };
    window.showWZDialog = function (controlId) {
        if (
            window["dialog_" + controlId] != undefined &&
            typeof window["dialog_" + controlId].show == "function"
        ) {
...
$(document).ready(function () {
    ...
    window.BindNewsEvent = function () {
        //上一页下一页的cookie也设置
        $("div[ctype=newsItemPreviousBind],div[ctype=newsItemNextBind]").each(
            function (x, y) {
                $(y)
                    .find("a[href]")
                    .each(function (a, b) {
                        ...
                        var prevNewsContentPageIndex = href.indexOf(
                            prevNewsContentPageFlag
                        );
            ...
            $(y)
                ...
                .each(function (a, b) {
                    ...
                    if (href && href.indexOf(newsInfoFlag) === 0) {
                        var targetNewsId = href
                            .substring(newsInfoFlag.length)
                            .split(".")[0];
